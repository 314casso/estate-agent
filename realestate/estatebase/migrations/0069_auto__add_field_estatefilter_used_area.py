...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EstateFilter.used_area'
        db.add_column('estatebase_estatefilter', 'used_area',
                      self.gf('estatebase.fields.MinMaxField')(max_length=25, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EstateFilter.used_area'
        db.delete_column('estatebase_estatefilter', 'used_area')
    ...
    models = {
        ...
        'estatebase.estatefilter': {
            ...
            'used_area': ('estatebase.fields.MinMaxField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
