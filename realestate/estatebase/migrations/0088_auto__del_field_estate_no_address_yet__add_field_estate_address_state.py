...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Estate.no_address_yet'
        db.delete_column('estatebase_estate', 'no_address_yet')

        # Adding field 'Estate.address_state'
        db.add_column('estatebase_estate', 'address_state',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Estate.no_address_yet'
        db.add_column('estatebase_estate', 'no_address_yet',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Estate.address_state'
        db.delete_column('estatebase_estate', 'address_state')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 30, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'estatebase.estate': {
            ...
            'address_state': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
