...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LayoutType.layout_category'
        db.add_column('estatebase_layouttype', 'layout_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.LayoutCategory'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'LayoutType.layout_category'
        db.delete_column('estatebase_layouttype', 'layout_category_id')
    ...
    models = {
        ...
        'estatebase.layoutcategory': {
            'Meta': {'ordering': "['name']", 'object_name': 'LayoutCategory'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255', 'db_index': 'True'})
        },
        ...
        'estatebase.layouttype': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'layout_category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['estatebase.LayoutCategory']", 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255', 'db_index': 'True'})
        },
        'estatebase.level': {
