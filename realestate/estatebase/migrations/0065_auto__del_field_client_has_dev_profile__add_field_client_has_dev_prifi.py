...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Client.has_dev_prifile'
        db.add_column('estatebase_client', 'has_dev_prifile',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Client.has_dev_prifile'
        db.delete_column('estatebase_client', 'has_dev_prifile')
    ...
    models = {
        ...
        'estatebase.client': {
            ...
            'has_dev_prifile': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'history': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['estatebase.HistoryMeta']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
