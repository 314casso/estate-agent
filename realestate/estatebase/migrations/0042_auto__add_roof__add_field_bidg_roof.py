...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bidg.roof'
        db.add_column('estatebase_bidg', 'roof',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Roof'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Bidg.roof'
        db.delete_column('estatebase_bidg', 'roof_id')
