...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EstateTypeCategory.independent'
        db.add_column('estatebase_estatetypecategory', 'independent',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'EstateType.independent'
        db.delete_column('estatebase_estatetype', 'independent')


    def backwards(self, orm):
        # Deleting field 'EstateTypeCategory.independent'
        db.delete_column('estatebase_estatetypecategory', 'independent')

        # Adding field 'EstateType.independent'
        db.add_column('estatebase_estatetype', 'independent',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
