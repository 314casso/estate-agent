...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Beside.name_dativ'
        db.add_column('estatebase_beside', 'name_dativ',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Beside.name_accus'
        db.add_column('estatebase_beside', 'name_accus',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Beside.name_dativ'
        db.delete_column('estatebase_beside', 'name_dativ')

        # Deleting field 'Beside.name_accus'
        db.delete_column('estatebase_beside', 'name_accus')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 18, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
