...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'GenericLink'
        db.delete_table('estatebase_genericlink')

        # Adding model 'ObjectLink'
        db.create_table('estatebase_objectlink', (
        ...
        db.send_create_signal('estatebase', ['ObjectLink'])

        # Adding model 'EntranceLinks'
        db.create_table('estatebase_entrancelinks', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('estatebase', ['EntranceLinks'])

        # Adding unique constraint on 'EntranceLinks', fields ['object_link', 'estate']
        db.create_unique('estatebase_entrancelinks', ['object_link_id', 'estate_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'EntranceLinks', fields ['object_link', 'estate']
        db.delete_unique('estatebase_entrancelinks', ['object_link_id', 'estate_id'])

        # Adding model 'GenericLink'
        db.create_table('estatebase_genericlink', (
            ('note', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal('estatebase', ['GenericLink'])

        # Deleting model 'ObjectLink'
        db.delete_table('estatebase_objectlink')

        # Deleting model 'EntranceLinks'
        db.delete_table('estatebase_entrancelinks')
    ...
    models = {
        ...
        'estatebase.entrancelinks': {
            'Meta': {'unique_together': "(('object_link', 'estate'),)", 'object_name': 'EntranceLinks'},
            'estate': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'objectlink_set'", 'to': "orm['estatebase.Estate']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_link': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['estatebase.ObjectLink']"})
        },
        'estatebase.estate': {
            ...
            'links': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'links'", 'to': "orm['estatebase.ObjectLink']", 'through': "orm['estatebase.EntranceLinks']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
