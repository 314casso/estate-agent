...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('estatebase_historymeta', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='creators', to=orm['auth.User'])),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='updators', null=True, to=orm['auth.User'])),
        ))
        db.send_create_signal('estatebase', ['HistoryMeta'])

        # Deleting field 'Estate.updated'
        db.delete_column('estatebase_estate', 'updated')

        # Deleting field 'Estate.updated_by'
        db.delete_column('estatebase_estate', 'updated_by_id')

        # Deleting field 'Estate.created'
        db.delete_column('estatebase_estate', 'created')

        # Deleting field 'Estate.created_by'
        db.delete_column('estatebase_estate', 'created_by_id')

        # Adding field 'Estate.history'
        db.add_column('estatebase_estate', 'history',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Estate.updated'
        db.add_column('estatebase_estate', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Estate.updated_by'
        db.add_column('estatebase_estate', 'updated_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='estate_updaters', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Estate.created'
        raise RuntimeError("Cannot reverse this migration. 'Estate.created' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Estate.created_by'
        raise RuntimeError("Cannot reverse this migration. 'Estate.created_by' and its values cannot be restored.")
        # Deleting field 'Estate.history'
        db.delete_column('estatebase_estate', 'history_id')
    ...
    models = {
        ...
        'estatebase.client': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'client_creators'", 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            ...
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'client_updaters'", 'null': 'True', 'to': "orm['auth.User']"})
        },
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 23, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
