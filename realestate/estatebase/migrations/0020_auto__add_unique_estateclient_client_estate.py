...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'EstateClient', fields ['client', 'estate']
        db.create_unique('estatebase_estateclient', ['client_id', 'estate_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'EstateClient', fields ['client', 'estate']
        db.delete_unique('estatebase_estateclient', ['client_id', 'estate_id'])
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 23, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
