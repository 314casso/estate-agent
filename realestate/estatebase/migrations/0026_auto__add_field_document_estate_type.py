...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.estate_type'
        db.add_column('estatebase_document', 'estate_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['estatebase.EstateType']),
                      keep_default=False)
