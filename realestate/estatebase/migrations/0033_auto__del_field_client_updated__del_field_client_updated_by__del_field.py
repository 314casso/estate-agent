...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Client.updated'
        db.delete_column('estatebase_client', 'updated')

        # Deleting field 'Client.updated_by'
        db.delete_column('estatebase_client', 'updated_by_id')

        # Deleting field 'Client.created'
        db.delete_column('estatebase_client', 'created')

        # Deleting field 'Client.created_by'
        db.delete_column('estatebase_client', 'created_by_id')

        # Adding field 'Client.history'
        db.add_column('estatebase_client', 'history',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['estatebase.HistoryMeta'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Client.updated'
        db.add_column('estatebase_client', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Client.updated_by'
        db.add_column('estatebase_client', 'updated_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='client_updaters', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Client.created'
        raise RuntimeError("Cannot reverse this migration. 'Client.created' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Client.created_by'
        raise RuntimeError("Cannot reverse this migration. 'Client.created_by' and its values cannot be restored.")
        # Deleting field 'Client.history'
        db.delete_column('estatebase_client', 'history_id')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 25, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
