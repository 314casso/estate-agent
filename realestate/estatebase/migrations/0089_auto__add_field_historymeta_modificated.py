...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoryMeta.modificated'
        db.add_column('estatebase_historymeta', 'modificated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 9, 27, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoryMeta.modificated'
        db.delete_column('estatebase_historymeta', 'modificated')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 27, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
