...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BidEvent.bid'
        db.add_column('estatebase_bidevent', 'bid',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['estatebase.Bid']),
                      keep_default=False)

        # Adding field 'BidEvent.bid_event_category'
        db.add_column('estatebase_bidevent', 'bid_event_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['estatebase.BidEventCategory']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BidEvent.bid'
        db.delete_column('estatebase_bidevent', 'bid_id')

        # Deleting field 'BidEvent.bid_event_category'
        db.delete_column('estatebase_bidevent', 'bid_event_category_id')
