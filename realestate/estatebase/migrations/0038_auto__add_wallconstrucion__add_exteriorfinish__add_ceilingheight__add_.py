...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CeilingHeight'
        db.create_table('estatebase_ceilingheight', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('estatebase', ['CeilingHeight'])
        ...
        # Adding field 'Bidg.wall_construcion'
        db.add_column('estatebase_bidg', 'wall_construcion',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.WallConstrucion'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bidg.exterior_finish'
        db.add_column('estatebase_bidg', 'exterior_finish',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.ExteriorFinish'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bidg.window_type'
        db.add_column('estatebase_bidg', 'window_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.WindowType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bidg.heating'
        db.add_column('estatebase_bidg', 'heating',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Heating'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bidg.ceiling_height'
        db.add_column('estatebase_bidg', 'ceiling_height',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.CeilingHeight'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CeilingHeight'
        db.delete_table('estatebase_ceilingheight')
        ...
        # Deleting field 'Bidg.wall_construcion'
        db.delete_column('estatebase_bidg', 'wall_construcion_id')

        # Deleting field 'Bidg.exterior_finish'
        db.delete_column('estatebase_bidg', 'exterior_finish_id')

        # Deleting field 'Bidg.window_type'
        db.delete_column('estatebase_bidg', 'window_type_id')

        # Deleting field 'Bidg.heating'
        db.delete_column('estatebase_bidg', 'heating_id')

        # Deleting field 'Bidg.ceiling_height'
        db.delete_column('estatebase_bidg', 'ceiling_height_id')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 27, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
