...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Office.address'
        db.alter_column('estatebase_office', 'address', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Office.address'
        db.alter_column('estatebase_office', 'address', self.gf('django.db.models.fields.CharField')(max_length=500))
