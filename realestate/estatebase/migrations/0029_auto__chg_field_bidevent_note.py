...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BidEvent.note'
        db.alter_column('estatebase_bidevent', 'note', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'BidEvent.note'
        db.alter_column('estatebase_bidevent', 'note', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
