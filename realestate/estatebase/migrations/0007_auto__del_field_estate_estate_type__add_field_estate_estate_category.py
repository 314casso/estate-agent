...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Estate.estate_type'
        db.delete_column('estatebase_estate', 'estate_type_id')

        # Adding field 'Estate.estate_category'
        db.add_column('estatebase_estate', 'estate_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['estatebase.EstateType'], on_delete=models.PROTECT),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Estate.estate_type'
        raise RuntimeError("Cannot reverse this migration. 'Estate.estate_type' and its values cannot be restored.")
        # Deleting field 'Estate.estate_category'
        db.delete_column('estatebase_estate', 'estate_category_id')
    ...
    models = {
        ...
        'estatebase.estate': {
            ...
            'estate_category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['estatebase.EstateType']", 'on_delete': 'models.PROTECT'}),
