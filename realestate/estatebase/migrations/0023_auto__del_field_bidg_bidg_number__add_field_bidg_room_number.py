...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Bidg.bidg_number'
        db.delete_column('estatebase_bidg', 'bidg_number')

        # Adding field 'Bidg.room_number'
        db.add_column('estatebase_bidg', 'room_number',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Bidg.bidg_number'
        raise RuntimeError("Cannot reverse this migration. 'Bidg.bidg_number' and its values cannot be restored.")
        # Deleting field 'Bidg.room_number'
        db.delete_column('estatebase_bidg', 'room_number')
