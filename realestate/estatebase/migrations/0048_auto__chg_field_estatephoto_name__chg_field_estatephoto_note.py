...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EstatePhoto.name'
        db.alter_column('estatebase_estatephoto', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'EstatePhoto.note'
        db.alter_column('estatebase_estatephoto', 'note', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'EstatePhoto.name'
        raise RuntimeError("Cannot reverse this migration. 'EstatePhoto.name' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'EstatePhoto.note'
        raise RuntimeError("Cannot reverse this migration. 'EstatePhoto.note' and its values cannot be restored.")
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 5, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'estatebase.estatephoto': {
            ...
            'estate': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photos'", 'to': "orm['estatebase.Estate']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
