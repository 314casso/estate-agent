...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Bidg', fields ['estate', 'basic']
        db.create_unique('estatebase_bidg', ['estate_id', 'basic'])


    def backwards(self, orm):
        # Removing unique constraint on 'Bidg', fields ['estate', 'basic']
        db.delete_unique('estatebase_bidg', ['estate_id', 'basic'])
    ...
    models = {
        ...
        'estatebase.bidg': {
            'Meta': {'unique_together': "(('estate', 'basic'),)", 'object_name': 'Bidg'},
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 13, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
