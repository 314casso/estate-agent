...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EstateFile.estate'
        db.delete_column('estatebase_estatefile', 'estate_id')

        # Adding field 'EstateFile.content_type'
        db.add_column('estatebase_estatefile', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'EstateFile.object_id'
        db.add_column('estatebase_estatefile', 'object_id',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'EstateFile.estate'
        raise RuntimeError("Cannot reverse this migration. 'EstateFile.estate' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'EstateFile.estate'
        db.add_column('estatebase_estatefile', 'estate',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='files', to=orm['estatebase.Estate']),
                      keep_default=False)

        # Deleting field 'EstateFile.content_type'
        db.delete_column('estatebase_estatefile', 'content_type_id')

        # Deleting field 'EstateFile.object_id'
        db.delete_column('estatebase_estatefile', 'object_id')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 6, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
