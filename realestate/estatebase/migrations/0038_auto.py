...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field estate_categories on 'Bid'
        db.create_table('estatebase_bid_estate_categories', (
        ...
        db.create_unique('estatebase_bid_estate_categories', ['bid_id', 'estatetypecategory_id'])


    def backwards(self, orm):
        # Removing M2M table for field estate_categories on 'Bid'
        db.delete_table('estatebase_bid_estate_categories')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 22, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
