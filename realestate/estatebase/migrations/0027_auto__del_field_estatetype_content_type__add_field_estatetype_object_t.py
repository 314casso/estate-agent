...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EstateType.content_type'
        db.delete_column('estatebase_estatetype', 'content_type_id')

        # Adding field 'EstateType.object_type'
        db.add_column('estatebase_estatetype', 'object_type',
                      self.gf('django.db.models.fields.CharField')(default='BIDG', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EstateType.content_type'
        db.add_column('estatebase_estatetype', 'content_type',
