...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Estate.comment'
        db.alter_column('estatebase_estate', 'comment', self.gf('django.db.models.fields.TextField')(max_length=255, null=True))
        # Adding field 'Bidg.year_built'
        db.add_column('estatebase_bidg', 'year_built',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bidg.floor'
        db.add_column('estatebase_bidg', 'floor',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bidg.elevator'
        db.add_column('estatebase_bidg', 'elevator',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Bidg.room_count'
        db.add_column('estatebase_bidg', 'room_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bidg.total_area'
        db.add_column('estatebase_bidg', 'total_area',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=1, blank=True),
                      keep_default=False)

        # Adding field 'Bidg.used_area'
        db.add_column('estatebase_bidg', 'used_area',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=1, blank=True),
                      keep_default=False)


        # Changing field 'Bidg.room_number'
        db.alter_column('estatebase_bidg', 'room_number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Estate.comment'
        db.alter_column('estatebase_estate', 'comment', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        # Deleting field 'Bidg.year_built'
        db.delete_column('estatebase_bidg', 'year_built')

        # Deleting field 'Bidg.floor'
        db.delete_column('estatebase_bidg', 'floor')

        # Deleting field 'Bidg.elevator'
        db.delete_column('estatebase_bidg', 'elevator')

        # Deleting field 'Bidg.room_count'
        db.delete_column('estatebase_bidg', 'room_count')

        # Deleting field 'Bidg.total_area'
        db.delete_column('estatebase_bidg', 'total_area')

        # Deleting field 'Bidg.used_area'
        db.delete_column('estatebase_bidg', 'used_area')


        # User chose to not deal with backwards NULL issues for 'Bidg.room_number'
        raise RuntimeError("Cannot reverse this migration. 'Bidg.room_number' and its values cannot be restored.")
    ...
    models = {
        ...
        'estatebase.bidg': {
            ...
            'total_area': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '1', 'blank': 'True'}),
            'used_area': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '1', 'blank': 'True'}),
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
