...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bid.client'
        db.alter_column('estatebase_bid', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['estatebase.Client']))
    ...
    models = {
        ...
        'estatebase.bid': {
            ...
            'client': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'bids'", 'null': 'True', 'to': "orm['estatebase.Client']"}),
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 10, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
