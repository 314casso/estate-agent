...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'LayoutCategory'
        db.delete_table('estatebase_layoutcategory')


        # Renaming column for 'LayoutType.layout_category' to match new field type.
        db.rename_column('estatebase_layouttype', 'layout_category_id', 'layout_category')
        # Changing field 'LayoutType.layout_category'
        db.alter_column('estatebase_layouttype', 'layout_category', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Removing index on 'LayoutType', fields ['layout_category']
        db.delete_index('estatebase_layouttype', ['layout_category_id'])


    def backwards(self, orm):
        # Adding index on 'LayoutType', fields ['layout_category']
        db.create_index('estatebase_layouttype', ['layout_category_id'])

        # Adding model 'LayoutCategory'
        db.create_table('estatebase_layoutcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, db_index=True)),
        ))
        db.send_create_signal('estatebase', ['LayoutCategory'])


        # Renaming column for 'LayoutType.layout_category' to match new field type.
        db.rename_column('estatebase_layouttype', 'layout_category', 'layout_category_id')
        # Changing field 'LayoutType.layout_category'
        db.alter_column('estatebase_layouttype', 'layout_category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.LayoutCategory'], null=True))
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 5, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
