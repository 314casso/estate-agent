...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BidEvent'
        db.create_table('estatebase_bidevent', (
        ...
        db.send_create_signal('estatebase', ['BidEvent'])

        # Adding M2M table for field estates on 'BidEvent'
        db.create_table('estatebase_bidevent_estates', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('bidevent', models.ForeignKey(orm['estatebase.bidevent'], null=False)),
            ('estate', models.ForeignKey(orm['estatebase.estate'], null=False))
        ))
        db.create_unique('estatebase_bidevent_estates', ['bidevent_id', 'estate_id'])

        # Adding model 'BidEventCategory'
        db.create_table('estatebase_bideventcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, db_index=True)),
            ('has_date', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('has_estates', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('estatebase', ['BidEventCategory'])


    def backwards(self, orm):
        # Deleting model 'BidEvent'
        db.delete_table('estatebase_bidevent')

        # Removing M2M table for field estates on 'BidEvent'
        db.delete_table('estatebase_bidevent_estates')

        # Deleting model 'BidEventCategory'
        db.delete_table('estatebase_bideventcategory')
    ...
    models = {
        ...
        'estatebase.bideventcategory': {
            ...
            'has_date': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'has_estates': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255', 'db_index': 'True'})
        },
        'estatebase.bidg': {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 18, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
