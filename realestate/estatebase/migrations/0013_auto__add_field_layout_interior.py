...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layout.interior'
        db.add_column('estatebase_layout', 'interior',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Interior'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layout.interior'
        db.delete_column('estatebase_layout', 'interior_id')
