...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Estate.estate_number'
        db.add_column('estatebase_estate', 'estate_number',
                      self.gf('django.db.models.fields.CharField')(default='1a', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Estate.estate_number'
        db.delete_column('estatebase_estate', 'estate_number')
