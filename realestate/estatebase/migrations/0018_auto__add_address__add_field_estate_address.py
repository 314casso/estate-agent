...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('estatebase_address', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('street', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Street'])),
        ))
        db.send_create_signal('estatebase', ['Address'])

        # Adding field 'Estate.address'
        db.add_column('estatebase_estate', 'address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Address'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Address'
        db.delete_table('estatebase_address')

        # Deleting field 'Estate.address'
        db.delete_column('estatebase_estate', 'address_id')
    ...
    models = {
        ...
        'estatebase.estate': {
            ...
            'address': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['estatebase.Address']", 'null': 'True', 'blank': 'True'}),
