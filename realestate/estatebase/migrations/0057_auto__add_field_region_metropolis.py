...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Region.metropolis'
        db.add_column('estatebase_region', 'metropolis',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='metropolis_region', null=True, on_delete=models.PROTECT, to=orm['estatebase.Locality']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Region.metropolis'
        db.delete_column('estatebase_region', 'metropolis_id')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 23, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
