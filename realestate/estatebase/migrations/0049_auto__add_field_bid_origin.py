...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bid.origin'
        db.add_column('estatebase_bid', 'origin',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Origin'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bid.origin'
        db.delete_column('estatebase_bid', 'origin_id')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 15, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
