...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'EstateRegister', fields ['name']
        db.delete_unique('estatebase_estateregister', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'EstateRegister', fields ['name']
        db.create_unique('estatebase_estateregister', ['name'])
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 28, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
