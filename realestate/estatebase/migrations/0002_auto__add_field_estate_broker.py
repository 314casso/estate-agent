...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Estate.broker'
        db.add_column('estatebase_estate', 'broker',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Estate.broker'
        db.delete_column('estatebase_estate', 'broker_id')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 4, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
