...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Estate.created'
        db.add_column('estatebase_estate', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 6, 23, 0, 0)),
                      keep_default=False)

        # Adding field 'Estate.created_by'
        db.add_column('estatebase_estate', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='estate_creators', to=orm['auth.User']),
                      keep_default=False)
        ...
        db.add_column('estatebase_estate', 'updated_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='estate_updaters', null=True, to=orm['auth.User']),
                      keep_default=False)
    ...
    models = {
        ...
        'estatebase.estate': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'estate_creators'", 'to': "orm['auth.User']"}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'estate_updaters'", 'null': 'True', 'to': "orm['auth.User']"}),
