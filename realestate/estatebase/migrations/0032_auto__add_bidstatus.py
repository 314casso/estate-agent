...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BidStatus'
        db.create_table('estatebase_bidstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, db_index=True)),
        ))
        db.send_create_signal('estatebase', ['BidStatus'])

        # Adding M2M table for field bid_status on 'Bid'
        db.create_table('estatebase_bid_bid_status', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('bid', models.ForeignKey(orm['estatebase.bid'], null=False)),
            ('bidstatus', models.ForeignKey(orm['estatebase.bidstatus'], null=False))
        ))
        db.create_unique('estatebase_bid_bid_status', ['bid_id', 'bidstatus_id'])


    def backwards(self, orm):
        # Deleting model 'BidStatus'
        db.delete_table('estatebase_bidstatus')

        # Removing M2M table for field bid_status on 'Bid'
        db.delete_table('estatebase_bid_bid_status')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 25, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
