...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Street.street_type'
        db.alter_column('estatebase_street', 'street_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['estatebase.StreetType'], on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'Street.street_type'
        db.alter_column('estatebase_street', 'street_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.StreetType'], null=True, on_delete=models.PROTECT))
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 17, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
