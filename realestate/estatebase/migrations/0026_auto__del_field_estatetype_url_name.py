...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EstateType.url_name'
        db.delete_column('estatebase_estatetype', 'url_name')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'EstateType.url_name'
        raise RuntimeError("Cannot reverse this migration. 'EstateType.url_name' and its values cannot be restored.")
