...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Estate.origin'
        db.add_column('estatebase_estate', 'origin',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Origin'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Estate.origin'
        db.delete_column('estatebase_estate', 'origin_id')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 10, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
