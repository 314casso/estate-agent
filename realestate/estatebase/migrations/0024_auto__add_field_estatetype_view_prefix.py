...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EstateType.view_prefix'
        db.add_column('estatebase_estatetype', 'view_prefix',
                      self.gf('django.db.models.fields.CharField')(default='apartment', max_length=50),
                      keep_default=False)
