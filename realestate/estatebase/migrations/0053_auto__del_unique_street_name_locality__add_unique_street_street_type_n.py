...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Street', fields ['street_type', 'name', 'locality']
        db.create_unique('estatebase_street', ['street_type_id', 'name', 'locality_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Street', fields ['street_type', 'name', 'locality']
        db.delete_unique('estatebase_street', ['street_type_id', 'name', 'locality_id'])
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 16, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'estatebase.street': {
            ...
            'locality': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['estatebase.Locality']", 'on_delete': 'models.PROTECT'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            'street_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['estatebase.StreetType']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'})
        },
