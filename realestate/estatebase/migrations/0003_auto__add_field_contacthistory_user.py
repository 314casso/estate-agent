...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactHistory.user'
        db.add_column('estatebase_contacthistory', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactHistory.user'
        db.delete_column('estatebase_contacthistory', 'user_id')
