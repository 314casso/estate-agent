...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bidg.total_area'
        db.alter_column('estatebase_bidg', 'total_area', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))

        # Changing field 'Bidg.used_area'
        db.alter_column('estatebase_bidg', 'used_area', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Bidg.total_area'
        db.alter_column('estatebase_bidg', 'total_area', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=1))

        # Changing field 'Bidg.used_area'
        db.alter_column('estatebase_bidg', 'used_area', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=1))
    ...
    models = {
        ...
        'estatebase.bidg': {
            ...
            'total_area': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
            'used_area': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
