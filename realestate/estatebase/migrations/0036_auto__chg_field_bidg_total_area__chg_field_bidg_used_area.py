...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('estatebase_bidg', 'total_area', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'Bidg.used_area'
        db.alter_column('estatebase_bidg', 'used_area', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Bidg.total_area'
        db.alter_column('estatebase_bidg', 'total_area', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

        # Changing field 'Bidg.used_area'
        db.alter_column('estatebase_bidg', 'used_area', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))
