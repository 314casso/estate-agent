...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Steed'
        db.delete_table('estatebase_steed')
    ...
    def backwards(self, orm):
        # Adding model 'Steed'
        db.create_table('estatebase_steed', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('estate', self.gf('django.db.models.fields.related.OneToOneField')(related_name='steed', unique=True, to=orm['estatebase.Estate'])),
        ))
        db.send_create_signal('estatebase', ['Steed'])
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 12, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
