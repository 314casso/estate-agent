...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field estate_type_category on 'Document'
        db.create_table('estatebase_document_estate_type_category', (
        ...
        db.create_unique('estatebase_document_estate_type_category', ['document_id', 'estatetypecategory_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field estate_type_category on 'Document'
        db.delete_table('estatebase_document_estate_type_category')
