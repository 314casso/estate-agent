...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EstateRegister.agency_price_min'
        db.delete_column('estatebase_estateregister', 'agency_price_min')

        # Deleting field 'EstateRegister.agency_price_max'
        db.delete_column('estatebase_estateregister', 'agency_price_max')

        # Removing M2M table for field estate_types on 'EstateRegister'
        db.delete_table('estatebase_estateregister_estate_types')

        # Removing M2M table for field regions on 'EstateRegister'
        db.delete_table('estatebase_estateregister_regions')

        # Removing M2M table for field localities on 'EstateRegister'
        db.delete_table('estatebase_estateregister_localities')


    def backwards(self, orm):
        # Adding field 'EstateRegister.agency_price_min'
        db.add_column('estatebase_estateregister', 'agency_price_min',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EstateRegister.agency_price_max'
        db.add_column('estatebase_estateregister', 'agency_price_max',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field estate_types on 'EstateRegister'
        db.create_table('estatebase_estateregister_estate_types', (
        ...
        db.create_unique('estatebase_estateregister_estate_types', ['estateregister_id', 'estatetype_id'])

        # Adding M2M table for field regions on 'EstateRegister'
        db.create_table('estatebase_estateregister_regions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('estateregister', models.ForeignKey(orm['estatebase.estateregister'], null=False)),
            ('region', models.ForeignKey(orm['estatebase.region'], null=False))
        ))
        db.create_unique('estatebase_estateregister_regions', ['estateregister_id', 'region_id'])

        # Adding M2M table for field localities on 'EstateRegister'
        db.create_table('estatebase_estateregister_localities', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('estateregister', models.ForeignKey(orm['estatebase.estateregister'], null=False)),
            ('locality', models.ForeignKey(orm['estatebase.locality'], null=False))
        ))
        db.create_unique('estatebase_estateregister_localities', ['estateregister_id', 'locality_id'])
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 21, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
