...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EstateFilter'
        db.create_table('estatebase_estatefilter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('estate_number', self.gf('estatebase.fields.MinMaxField')(max_length=25, null=True, blank=True)),
            ('room_number', self.gf('estatebase.fields.MinMaxField')(max_length=25, null=True, blank=True)),
            ('agency_price', self.gf('estatebase.fields.MinMaxField')(max_length=25, null=True, blank=True)),
            ('year_built', self.gf('estatebase.fields.MinMaxField')(max_length=25, null=True, blank=True)),
            ('floor', self.gf('estatebase.fields.MinMaxField')(max_length=25, null=True, blank=True)),
            ('floor_count', self.gf('estatebase.fields.MinMaxField')(max_length=25, null=True, blank=True)),
            ('total_area', self.gf('estatebase.fields.MinMaxField')(max_length=25, null=True, blank=True)),
        ))
        db.send_create_signal('estatebase', ['EstateFilter'])

        # Adding M2M table for field esate on 'EstateFilter'
        db.create_table('estatebase_estatefilter_esate', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('estatefilter', models.ForeignKey(orm['estatebase.estatefilter'], null=False)),
            ('estate', models.ForeignKey(orm['estatebase.estate'], null=False))
        ))
        db.create_unique('estatebase_estatefilter_esate', ['estatefilter_id', 'estate_id'])

        # Adding M2M table for field estate_type on 'EstateFilter'
        db.create_table('estatebase_estatefilter_estate_type', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('estatefilter', models.ForeignKey(orm['estatebase.estatefilter'], null=False)),
            ('estatetype', models.ForeignKey(orm['estatebase.estatetype'], null=False))
        ))
        db.create_unique('estatebase_estatefilter_estate_type', ['estatefilter_id', 'estatetype_id'])

        # Adding M2M table for field region on 'EstateFilter'
        db.create_table('estatebase_estatefilter_region', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('estatefilter', models.ForeignKey(orm['estatebase.estatefilter'], null=False)),
            ('region', models.ForeignKey(orm['estatebase.region'], null=False))
        ))
        db.create_unique('estatebase_estatefilter_region', ['estatefilter_id', 'region_id'])

        # Adding M2M table for field localitie on 'EstateFilter'
        db.create_table('estatebase_estatefilter_localitie', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('estatefilter', models.ForeignKey(orm['estatebase.estatefilter'], null=False)),
            ('locality', models.ForeignKey(orm['estatebase.locality'], null=False))
        ))
        db.create_unique('estatebase_estatefilter_localitie', ['estatefilter_id', 'locality_id'])

        # Adding M2M table for field microdistrict on 'EstateFilter'
        db.create_table('estatebase_estatefilter_microdistrict', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('estatefilter', models.ForeignKey(orm['estatebase.estatefilter'], null=False)),
            ('microdistrict', models.ForeignKey(orm['estatebase.microdistrict'], null=False))
        ))
        db.create_unique('estatebase_estatefilter_microdistrict', ['estatefilter_id', 'microdistrict_id'])

        # Adding M2M table for field street on 'EstateFilter'
        db.create_table('estatebase_estatefilter_street', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('estatefilter', models.ForeignKey(orm['estatebase.estatefilter'], null=False)),
            ('street', models.ForeignKey(orm['estatebase.street'], null=False))
        ))
        db.create_unique('estatebase_estatefilter_street', ['estatefilter_id', 'street_id'])

        # Adding M2M table for field estate_status on 'EstateFilter'
        db.create_table('estatebase_estatefilter_estate_status', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('estatefilter', models.ForeignKey(orm['estatebase.estatefilter'], null=False)),
            ('estatestatus', models.ForeignKey(orm['estatebase.estatestatus'], null=False))
        ))
        db.create_unique('estatebase_estatefilter_estate_status', ['estatefilter_id', 'estatestatus_id'])

        # Adding M2M table for field client on 'EstateFilter'
        db.create_table('estatebase_estatefilter_client', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('estatefilter', models.ForeignKey(orm['estatebase.estatefilter'], null=False)),
            ('client', models.ForeignKey(orm['estatebase.client'], null=False))
        ))
        db.create_unique('estatebase_estatefilter_client', ['estatefilter_id', 'client_id'])

        # Adding M2M table for field contact on 'EstateFilter'
        db.create_table('estatebase_estatefilter_contact', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('estatefilter', models.ForeignKey(orm['estatebase.estatefilter'], null=False)),
            ('contact', models.ForeignKey(orm['estatebase.contact'], null=False))
        ))
        db.create_unique('estatebase_estatefilter_contact', ['estatefilter_id', 'contact_id'])

        # Adding M2M table for field wall_construcion on 'EstateFilter'
        db.create_table('estatebase_estatefilter_wall_construcion', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('estatefilter', models.ForeignKey(orm['estatebase.estatefilter'], null=False)),
            ('wallconstrucion', models.ForeignKey(orm['estatebase.wallconstrucion'], null=False))
        ))
        db.create_unique('estatebase_estatefilter_wall_construcion', ['estatefilter_id', 'wallconstrucion_id'])


    def backwards(self, orm):
        # Deleting model 'EstateFilter'
        db.delete_table('estatebase_estatefilter')

        # Removing M2M table for field esate on 'EstateFilter'
        db.delete_table('estatebase_estatefilter_esate')

        # Removing M2M table for field estate_type on 'EstateFilter'
        db.delete_table('estatebase_estatefilter_estate_type')

        # Removing M2M table for field region on 'EstateFilter'
        db.delete_table('estatebase_estatefilter_region')

        # Removing M2M table for field localitie on 'EstateFilter'
        db.delete_table('estatebase_estatefilter_localitie')

        # Removing M2M table for field microdistrict on 'EstateFilter'
        db.delete_table('estatebase_estatefilter_microdistrict')

        # Removing M2M table for field street on 'EstateFilter'
        db.delete_table('estatebase_estatefilter_street')

        # Removing M2M table for field estate_status on 'EstateFilter'
        db.delete_table('estatebase_estatefilter_estate_status')

        # Removing M2M table for field client on 'EstateFilter'
        db.delete_table('estatebase_estatefilter_client')

        # Removing M2M table for field contact on 'EstateFilter'
        db.delete_table('estatebase_estatefilter_contact')

        # Removing M2M table for field wall_construcion on 'EstateFilter'
        db.delete_table('estatebase_estatefilter_wall_construcion')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 23, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'estatebase.estatefilter': {
            'Meta': {'object_name': 'EstateFilter'},
            'agency_price': ('estatebase.fields.MinMaxField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'client': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['estatebase.Client']", 'null': 'True', 'blank': 'True'}),
            'contact': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['estatebase.Contact']", 'null': 'True', 'blank': 'True'}),
            'esate': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['estatebase.Estate']", 'null': 'True', 'blank': 'True'}),
            'estate_number': ('estatebase.fields.MinMaxField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'estate_status': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['estatebase.EstateStatus']", 'null': 'True', 'blank': 'True'}),
            'estate_type': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['estatebase.EstateType']", 'null': 'True', 'blank': 'True'}),
            'floor': ('estatebase.fields.MinMaxField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'floor_count': ('estatebase.fields.MinMaxField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'localitie': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['estatebase.Locality']", 'null': 'True', 'blank': 'True'}),
            'microdistrict': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['estatebase.Microdistrict']", 'null': 'True', 'blank': 'True'}),
            'region': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['estatebase.Region']", 'null': 'True', 'blank': 'True'}),
            'room_number': ('estatebase.fields.MinMaxField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'street': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['estatebase.Street']", 'null': 'True', 'blank': 'True'}),
            'total_area': ('estatebase.fields.MinMaxField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'wall_construcion': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['estatebase.WallConstrucion']", 'null': 'True', 'blank': 'True'}),
            'year_built': ('estatebase.fields.MinMaxField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'})
        },
