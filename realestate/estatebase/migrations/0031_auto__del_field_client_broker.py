...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('estatebase_client', 'broker',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='clientbrokers', null=True, to=orm['auth.User'], on_delete=models.PROTECT, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 22, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
