...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContactHistory.contact'
        db.add_column('estatebase_contacthistory', 'contact', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['estatebase.Contact']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContactHistory.contact'
        db.delete_column('estatebase_contacthistory', 'contact_id')
