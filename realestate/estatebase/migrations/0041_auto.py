...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field brokers on 'Bid'
        db.create_table('estatebase_bid_brokers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('bid', models.ForeignKey(orm['estatebase.bid'], null=False)),
            ('exuser', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('estatebase_bid_brokers', ['bid_id', 'exuser_id'])


    def backwards(self, orm):
        # Removing M2M table for field brokers on 'Bid'
        db.delete_table('estatebase_bid_brokers')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 23, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
