...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.has_dev_profile'
        db.add_column('estatebase_client', 'has_dev_profile',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Client.dev_profile'
        db.add_column('estatebase_client', 'dev_profile',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['devrep.DevProfile'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Client.extra_profile'
        db.add_column('estatebase_client', 'extra_profile',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['devrep.ExtraProfile'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.has_dev_profile'
        db.delete_column('estatebase_client', 'has_dev_profile')

        # Deleting field 'Client.dev_profile'
        db.delete_column('estatebase_client', 'dev_profile_id')

        # Deleting field 'Client.extra_profile'
        db.delete_column('estatebase_client', 'extra_profile_id')
    ...
    models = {
        ...
        'devrep.extraprofile': {
            ...
            'birthday': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 31, 0, 0)', 'blank': 'True'}),
        ...
        'estatebase.client': {
            ...
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'dev_profile': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['devrep.DevProfile']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'extra_profile': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['devrep.ExtraProfile']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 31, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
