...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Stead.total_area'
        db.add_column('estatebase_stead', 'total_area',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Stead.face_area'
        db.add_column('estatebase_stead', 'face_area',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Stead.shape'
        db.add_column('estatebase_stead', 'shape',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Shape'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Stead.land_type'
        db.add_column('estatebase_stead', 'land_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.LandType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Stead.purpose'
        db.add_column('estatebase_stead', 'purpose',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Purpose'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Stead.total_area'
        db.delete_column('estatebase_stead', 'total_area')

        # Deleting field 'Stead.face_area'
        db.delete_column('estatebase_stead', 'face_area')

        # Deleting field 'Stead.shape'
        db.delete_column('estatebase_stead', 'shape_id')

        # Deleting field 'Stead.land_type'
        db.delete_column('estatebase_stead', 'land_type_id')

        # Deleting field 'Stead.purpose'
        db.delete_column('estatebase_stead', 'purpose_id')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 16, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
