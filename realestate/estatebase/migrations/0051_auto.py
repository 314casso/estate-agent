...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field geo_groups on 'Bid'
        m2m_table_name = db.shorten_name('estatebase_bid_geo_groups')
        ...
        db.create_unique(m2m_table_name, ['bid_id', 'geogroup_id'])


    def backwards(self, orm):
        # Removing M2M table for field geo_groups on 'Bid'
        db.delete_table(db.shorten_name('estatebase_bid_geo_groups'))
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 19, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
