...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Locality', fields ['region', 'name']
        db.create_unique('estatebase_locality', ['region_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Locality', fields ['region', 'name']
        db.delete_unique('estatebase_locality', ['region_id', 'name'])
