...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field documents on 'Stead'
        db.create_table('estatebase_stead_documents', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('stead', models.ForeignKey(orm['estatebase.stead'], null=False)),
            ('document', models.ForeignKey(orm['estatebase.document'], null=False))
        ))
        db.create_unique('estatebase_stead_documents', ['stead_id', 'document_id'])


    def backwards(self, orm):
        # Removing M2M table for field documents on 'Stead'
        db.delete_table('estatebase_stead_documents')
