...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EstateRegister.broker'
        db.delete_column('estatebase_estateregister', 'broker_id')


    def backwards(self, orm):
        # Adding field 'EstateRegister.broker'
        db.add_column('estatebase_estateregister', 'broker',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='estate_registers', null=True, to=orm['auth.User'], on_delete=models.PROTECT, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
