...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Office'
        db.create_table('estatebase_office', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, db_index=True)),
            ('region', self.gf('django.db.models.fields.related.ForeignKey')(related_name='offices', on_delete=models.PROTECT, to=orm['estatebase.Region'])),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal('estatebase', ['Office'])

        # Adding field 'UserProfile.office'
        db.add_column('estatebase_userprofile', 'office',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Office'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Office'
        db.delete_table('estatebase_office')

        # Deleting field 'UserProfile.office'
        db.delete_column('estatebase_userprofile', 'office_id')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 14, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'estatebase.layout': {
            'Meta': {'ordering': "['layout_type']", 'object_name': 'Layout'},
        ...
        'estatebase.office': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255', 'db_index': 'True'}),
            'region': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'offices'", 'on_delete': 'models.PROTECT', 'to': "orm['estatebase.Region']"})
        },
        'estatebase.origin': {
