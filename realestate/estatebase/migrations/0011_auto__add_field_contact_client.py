...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact.client'
        db.add_column('estatebase_contact', 'client', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['estatebase.Client']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.client'
        db.delete_column('estatebase_contact', 'client_id')
