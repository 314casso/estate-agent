...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('estatebase_bidg', (
            ('estate_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['estatebase.Estate'], unique=True, primary_key=True)),
        ...
        db.create_table('estatebase_client', (
            ...
            ('origin', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Origin'], null=True, blank=True)),
        ...
        db.create_table('estatebase_contacthistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 5, 29, 0, 0))),
        ...
        db.create_table('estatebase_contact', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contactlist', to=orm['estatebase.Client'])),
            ...
            ('updated', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('contact_state', self.gf('django.db.models.fields.related.ForeignKey')(default=5, to=orm['estatebase.ContactState'])),
        ))
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 29, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
