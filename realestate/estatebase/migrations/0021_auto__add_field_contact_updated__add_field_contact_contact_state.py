...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('estatebase_contact', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Contact.contact_state'
        db.add_column('estatebase_contact', 'contact_state',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['estatebase.ContactState']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.updated'
        db.delete_column('estatebase_contact', 'updated')

        # Deleting field 'Contact.contact_state'
        db.delete_column('estatebase_contact', 'contact_state_id')
