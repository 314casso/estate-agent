...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EstateRegister.name'
        db.add_column('estatebase_estateregister', 'name',
                      self.gf('django.db.models.fields.CharField')(default='New', unique=True, max_length=255, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EstateRegister.name'
        db.delete_column('estatebase_estateregister', 'name')
