...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bidg.floor_count'
        db.alter_column('estatebase_bidg', 'floor_count', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))

    def backwards(self, orm):

        # Changing field 'Bidg.floor_count'
        db.alter_column('estatebase_bidg', 'floor_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 10, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
