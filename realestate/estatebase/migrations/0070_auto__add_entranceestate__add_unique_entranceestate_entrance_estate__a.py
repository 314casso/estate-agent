...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EntranceEstate'
        db.create_table('estatebase_entranceestate', (
            ...
            ('entrance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Entrance'])),
            ('estate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Estate'])),
        ))
        db.send_create_signal('estatebase', ['EntranceEstate'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EntranceEstate'
        db.delete_table('estatebase_entranceestate')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 13, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'estatebase.entrance': {
            'Meta': {'ordering': "['name']", 'object_name': 'Entrance'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255', 'db_index': 'True'}),
            'name_gent': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'name_loct': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'estatebase.entranceestate': {
            'Meta': {'unique_together': "(('entrance', 'estate'),)", 'object_name': 'EntranceEstate'},
            'basic': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'distance': ('django.db.models.fields.IntegerField', [], {}),
            'entrance': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['estatebase.Entrance']"}),
        ...
        'estatebase.estate': {
            ...
            'entrances': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['estatebase.Entrance']", 'null': 'True', 'through': "orm['estatebase.EntranceEstate']", 'blank': 'True'}),
