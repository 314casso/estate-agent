...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.deleted'
        db.add_column('estatebase_client', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.deleted'
        db.delete_column('estatebase_client', 'deleted')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 10, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
