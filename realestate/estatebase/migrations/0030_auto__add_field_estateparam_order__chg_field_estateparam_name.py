...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EstateParam.order'
        db.add_column('estatebase_estateparam', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, unique=True, blank=True),
                      keep_default=False)


        # Changing field 'EstateParam.name'
        db.alter_column('estatebase_estateparam', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'EstateParam.order'
        db.delete_column('estatebase_estateparam', 'order')


        # Changing field 'EstateParam.name'
        db.alter_column('estatebase_estateparam', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 21, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
