...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'estatebase.entrancelink': {
            'Meta': {'unique_together': "(('object_link', 'estate'),)", 'object_name': 'EntranceLink'},
        ...
        'estatebase.estate': {
            ...
            'links': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'links'", 'to': "orm['estatebase.ObjectLink']", 'through': "orm['estatebase.EntranceLink']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
