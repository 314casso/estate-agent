...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.broker'
        db.add_column('estatebase_client', 'broker',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='clientbrokers', null=True, on_delete=models.PROTECT, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.broker'
        db.delete_column('estatebase_client', 'broker_id')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 11, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
