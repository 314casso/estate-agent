...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Office.address_short'
        db.add_column('estatebase_office', 'address_short',
                      self.gf('django.db.models.fields.TextField')(default='Address'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Office.address_short'
        db.delete_column('estatebase_office', 'address_short')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 21, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
