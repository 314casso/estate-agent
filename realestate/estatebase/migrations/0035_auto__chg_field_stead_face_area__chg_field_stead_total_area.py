...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Stead.face_area'
        db.alter_column('estatebase_stead', 'face_area', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'Stead.total_area'
        db.alter_column('estatebase_stead', 'total_area', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Stead.face_area'
        db.alter_column('estatebase_stead', 'face_area', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

        # Changing field 'Stead.total_area'
        db.alter_column('estatebase_stead', 'total_area', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 17, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
