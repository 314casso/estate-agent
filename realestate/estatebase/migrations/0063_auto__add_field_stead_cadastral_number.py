...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stead.cadastral_number'
        db.add_column('estatebase_stead', 'cadastral_number',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stead.cadastral_number'
        db.delete_column('estatebase_stead', 'cadastral_number')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 5, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
