...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Validity'
        db.create_table('estatebase_validity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, db_index=True)),
        ))
        db.send_create_signal('estatebase', ['Validity'])

        # Deleting field 'Estate.valid'
        db.delete_column('estatebase_estate', 'valid')

        # Adding field 'Estate.validity'
        db.add_column('estatebase_estate', 'validity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Validity'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Validity'
        db.delete_table('estatebase_validity')

        # Adding field 'Estate.valid'
        db.add_column('estatebase_estate', 'valid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Estate.validity'
        db.delete_column('estatebase_estate', 'validity_id')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 6, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
