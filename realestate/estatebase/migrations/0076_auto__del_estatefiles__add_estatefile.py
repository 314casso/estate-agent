...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'EstateFiles'
        db.delete_table('estatebase_estatefiles')

        # Adding model 'EstateFile'
        db.create_table('estatebase_estatefile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True, blank=True)),
            ('estate', self.gf('django.db.models.fields.related.ForeignKey')(related_name='files', to=orm['estatebase.Estate'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('note', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('estatebase', ['EstateFile'])


    def backwards(self, orm):
        # Adding model 'EstateFiles'
        db.create_table('estatebase_estatefiles', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('estate', self.gf('django.db.models.fields.related.ForeignKey')(related_name='files', to=orm['estatebase.Estate'])),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True, blank=True)),
            ('note', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ...
        db.send_create_signal('estatebase', ['EstateFiles'])

        # Deleting model 'EstateFile'
        db.delete_table('estatebase_estatefile')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 4, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'estatebase.estatefile': {
            ...
            'estate': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'files'", 'to': "orm['estatebase.Estate']"}),
