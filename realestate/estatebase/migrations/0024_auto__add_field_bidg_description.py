...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bidg.description'
        db.add_column('estatebase_bidg', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bidg.description'
        db.delete_column('estatebase_bidg', 'description')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 11, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
