...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Locality.geo_group'
        db.add_column('estatebase_locality', 'geo_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['estatebase.GeoGroup']),
                      keep_default=False)
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 10, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
