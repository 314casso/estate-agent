...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field estate_registers on 'Bid'
        db.create_table('estatebase_bid_estate_registers', (
        ...
        db.create_unique('estatebase_bid_estate_registers', ['bid_id', 'estateregister_id'])


    def backwards(self, orm):
        # Removing M2M table for field estate_registers on 'Bid'
        db.delete_table('estatebase_bid_estate_registers')
    ...
    models = {
        ...
        'estatebase.bid': {
            ...
            'estate_registers': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['estatebase.EstateRegister']", 'null': 'True', 'blank': 'True'}),
