...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('estatebase_appliance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, db_index=True)),
        ))
        db.send_create_signal('estatebase', ['Appliance'])

        # Adding M2M table for field appliances on 'Bidg'
        db.create_table('estatebase_bidg_appliances', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('bidg', models.ForeignKey(orm['estatebase.bidg'], null=False)),
            ('appliance', models.ForeignKey(orm['estatebase.appliance'], null=False))
        ))
        db.create_unique('estatebase_bidg_appliances', ['bidg_id', 'appliance_id'])


    def backwards(self, orm):
        # Deleting model 'Appliance'
        db.delete_table('estatebase_appliance')

        # Removing M2M table for field appliances on 'Bidg'
        db.delete_table('estatebase_bidg_appliances')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 17, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
