...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BidClient'
        db.create_table('estatebase_bidclient', (
        ...
        db.send_create_signal('estatebase', ['BidClient'])

        # Adding unique constraint on 'BidClient', fields ['client', 'bid']
        db.create_unique('estatebase_bidclient', ['client_id', 'bid_id'])

        # Removing M2M table for field clients on 'Bid'
        db.delete_table(db.shorten_name('estatebase_bid_clients'))


    def backwards(self, orm):
        # Removing unique constraint on 'BidClient', fields ['client', 'bid']
        db.delete_unique('estatebase_bidclient', ['client_id', 'bid_id'])

        # Deleting model 'BidClient'
        db.delete_table('estatebase_bidclient')

        # Adding M2M table for field clients on 'Bid'
        m2m_table_name = db.shorten_name('estatebase_bid_clients')
        ...
        db.create_unique(m2m_table_name, ['bid_id', 'client_id'])
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 1, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
