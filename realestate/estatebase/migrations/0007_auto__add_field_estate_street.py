...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Estate.street'
        db.add_column('estatebase_estate', 'street',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Street'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Estate.street'
        db.delete_column('estatebase_estate', 'street_id')
    ...
    models = {
        ...
        'estatebase.estate': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'street': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['estatebase.Street']", 'null': 'True', 'blank': 'True'})
        },
