...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EntranceEstate.distance'
        db.alter_column('estatebase_entranceestate', 'distance', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'EntranceEstate.distance'
        raise RuntimeError("Cannot reverse this migration. 'EntranceEstate.distance' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'EntranceEstate.distance'
        db.alter_column('estatebase_entranceestate', 'distance', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 19, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
