...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Contact', fields ['contact']
        db.create_unique('estatebase_contact', ['contact'])


    def backwards(self, orm):
        # Removing unique constraint on 'Contact', fields ['contact']
        db.delete_unique('estatebase_contact', ['contact'])
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
