...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('estatebase_dealstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, db_index=True)),
        ))
        db.send_create_signal('estatebase', ['DealStatus'])

        # Adding field 'Estate.deal_status'
        db.add_column('estatebase_estate', 'deal_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.DealStatus'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DealStatus'
        db.delete_table('estatebase_dealstatus')

        # Deleting field 'Estate.deal_status'
        db.delete_column('estatebase_estate', 'deal_status_id')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 20, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
