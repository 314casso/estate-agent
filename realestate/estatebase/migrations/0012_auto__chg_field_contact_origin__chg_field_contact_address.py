...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.origin'
        db.alter_column('estatebase_contact', 'origin_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Origin'], null=True))

        # Changing field 'Contact.address'
        db.alter_column('estatebase_contact', 'address', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Contact.origin'
        raise RuntimeError("Cannot reverse this migration. 'Contact.origin' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Contact.address'
        raise RuntimeError("Cannot reverse this migration. 'Contact.address' and its values cannot be restored.")
