...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 3, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'estatebase.estatefiles': {
            'Meta': {'ordering': "['order']", 'object_name': 'EstateFiles'},
