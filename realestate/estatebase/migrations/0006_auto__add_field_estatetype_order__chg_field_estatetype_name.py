...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EstateType.order'
        db.add_column('estatebase_estatetype', 'order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, unique=True, blank=True), keep_default=False)

        # Changing field 'EstateType.name'
        db.alter_column('estatebase_estatetype', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Deleting field 'EstateType.order'
        db.delete_column('estatebase_estatetype', 'order')

        # Changing field 'EstateType.name'
        db.alter_column('estatebase_estatetype', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
