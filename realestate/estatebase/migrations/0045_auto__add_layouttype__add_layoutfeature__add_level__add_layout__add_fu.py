...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('estatebase_layout', (
            ...
            ('layout_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.LayoutType'])),
            ('area', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True)),
            ('furniture', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Furniture'], null=True, blank=True)),
            ('layout_feature', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.LayoutFeature'], null=True, blank=True)),
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 2, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
