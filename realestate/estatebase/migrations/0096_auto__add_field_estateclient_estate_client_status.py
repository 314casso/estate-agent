...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EstateClient.estate_client_status'
        db.add_column('estatebase_estateclient', 'estate_client_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['estatebase.EstateClientStatus']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EstateClient.estate_client_status'
        db.delete_column('estatebase_estateclient', 'estate_client_status_id')
    ...
    models = {
        ...
        'estatebase.estateclient': {
            ...
            'estate_client_status': ('django.db.models.fields.related.ForeignKey', [], {'default': '3', 'to': "orm['estatebase.EstateClientStatus']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
