...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('estatebase_bidg', 'estate_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=16, to=orm['estatebase.EstateType']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Bidg.estate_type'
        db.alter_column('estatebase_bidg', 'estate_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.EstateType'], null=True))
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
