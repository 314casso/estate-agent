...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BidEventCategory.has_date'
        db.delete_column('estatebase_bideventcategory', 'has_date')

        # Deleting field 'BidEventCategory.has_estates'
        db.delete_column('estatebase_bideventcategory', 'has_estates')


    def backwards(self, orm):
        # Adding field 'BidEventCategory.has_date'
        db.add_column('estatebase_bideventcategory', 'has_date',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BidEventCategory.has_estates'
        db.add_column('estatebase_bideventcategory', 'has_estates',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
