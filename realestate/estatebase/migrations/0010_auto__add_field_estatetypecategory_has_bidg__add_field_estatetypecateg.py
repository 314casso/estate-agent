...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EstateTypeCategory.has_bidg'
        db.add_column('estatebase_estatetypecategory', 'has_bidg',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'EstateTypeCategory.has_stead'
        db.add_column('estatebase_estatetypecategory', 'has_stead',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'EstateTypeCategory.is_commerce'
        db.add_column('estatebase_estatetypecategory', 'is_commerce',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'EstateType.has_stead'
        db.delete_column('estatebase_estatetype', 'has_stead')

        # Deleting field 'EstateType.has_bidg'
        db.delete_column('estatebase_estatetype', 'has_bidg')


    def backwards(self, orm):
        # Deleting field 'EstateTypeCategory.has_bidg'
        db.delete_column('estatebase_estatetypecategory', 'has_bidg')

        # Deleting field 'EstateTypeCategory.has_stead'
        db.delete_column('estatebase_estatetypecategory', 'has_stead')

        # Deleting field 'EstateTypeCategory.is_commerce'
        db.delete_column('estatebase_estatetypecategory', 'is_commerce')


        # User chose to not deal with backwards NULL issues for 'EstateType.has_stead'
        raise RuntimeError("Cannot reverse this migration. 'EstateType.has_stead' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'EstateType.has_bidg'
        raise RuntimeError("Cannot reverse this migration. 'EstateType.has_bidg' and its values cannot be restored.")
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 11, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'estatebase.estate': {
            ...
            'com_status': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
