...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bid.cleaned_filter'
        db.add_column('estatebase_bid', 'cleaned_filter',
                      self.gf('picklefield.fields.PickledObjectField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bid.cleaned_filter'
        db.delete_column('estatebase_bid', 'cleaned_filter')
