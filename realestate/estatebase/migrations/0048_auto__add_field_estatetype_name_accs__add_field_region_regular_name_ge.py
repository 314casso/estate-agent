...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EstateType.name_accs'
        db.add_column('estatebase_estatetype', 'name_accs',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Region.regular_name_gent'
        db.add_column('estatebase_region', 'regular_name_gent',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Beside.name_gent'
        db.add_column('estatebase_beside', 'name_gent',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Beside.name_loct'
        db.add_column('estatebase_beside', 'name_loct',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locality.name_gent'
        db.add_column('estatebase_locality', 'name_gent',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locality.name_loct'
        db.add_column('estatebase_locality', 'name_loct',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EstateType.name_accs'
        db.delete_column('estatebase_estatetype', 'name_accs')

        # Deleting field 'Region.regular_name_gent'
        db.delete_column('estatebase_region', 'regular_name_gent')

        # Deleting field 'Beside.name_gent'
        db.delete_column('estatebase_beside', 'name_gent')

        # Deleting field 'Beside.name_loct'
        db.delete_column('estatebase_beside', 'name_loct')

        # Deleting field 'Locality.name_gent'
        db.delete_column('estatebase_locality', 'name_gent')

        # Deleting field 'Locality.name_loct'
        db.delete_column('estatebase_locality', 'name_loct')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 20, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
