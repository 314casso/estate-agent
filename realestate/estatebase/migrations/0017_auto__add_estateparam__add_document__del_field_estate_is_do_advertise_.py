...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field documents on 'Estate'
        db.create_table('estatebase_estate_documents', (
        ...
        db.create_unique('estatebase_estate_documents', ['estate_id', 'estateparam_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field documents on 'Estate'
        db.delete_table('estatebase_estate_documents')
    ...
    models = {
        ...
        'estatebase.estate': {
            ...
            'documents': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['estatebase.EstateParam']", 'null': 'True', 'blank': 'True'}),
        ...
        'estatebase.estateparam': {
            'Meta': {'ordering': "['name']", 'object_name': 'EstateParam'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
