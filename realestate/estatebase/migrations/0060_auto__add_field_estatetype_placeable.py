...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EstateType.placeable'
        db.add_column('estatebase_estatetype', 'placeable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EstateType.placeable'
        db.delete_column('estatebase_estatetype', 'placeable')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 31, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
