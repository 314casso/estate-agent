...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Estate.contact'
        db.add_column('estatebase_estate', 'contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Contact'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Estate.contact'
        db.delete_column('estatebase_estate', 'contact_id')
    ...
    models = {
        ...
        'estatebase.estate': {
            ...
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['estatebase.Contact']", 'null': 'True', 'blank': 'True'}),
