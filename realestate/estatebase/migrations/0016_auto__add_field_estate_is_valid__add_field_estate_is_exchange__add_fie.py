...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Estate.is_valid'
        db.add_column('estatebase_estate', 'is_valid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Estate.is_exchange'
        db.add_column('estatebase_estate', 'is_exchange',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Estate.is_hypothec'
        db.add_column('estatebase_estate', 'is_hypothec',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Estate.is_exclusive'
        db.add_column('estatebase_estate', 'is_exclusive',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Estate.is_do_photo'
        db.add_column('estatebase_estate', 'is_do_photo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Estate.is_do_advertise'
        db.add_column('estatebase_estate', 'is_do_advertise',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Estate.description'
        db.add_column('estatebase_estate', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Estate.comment'
        db.add_column('estatebase_estate', 'comment',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Estate.is_valid'
        db.delete_column('estatebase_estate', 'is_valid')

        # Deleting field 'Estate.is_exchange'
        db.delete_column('estatebase_estate', 'is_exchange')

        # Deleting field 'Estate.is_hypothec'
        db.delete_column('estatebase_estate', 'is_hypothec')

        # Deleting field 'Estate.is_exclusive'
        db.delete_column('estatebase_estate', 'is_exclusive')

        # Deleting field 'Estate.is_do_photo'
        db.delete_column('estatebase_estate', 'is_do_photo')

        # Deleting field 'Estate.is_do_advertise'
        db.delete_column('estatebase_estate', 'is_do_advertise')

        # Deleting field 'Estate.description'
        db.delete_column('estatebase_estate', 'description')

        # Deleting field 'Estate.comment'
        db.delete_column('estatebase_estate', 'comment')
    ...
    models = {
        ...
        'estatebase.bidg': {
            ...
            'bidg_number': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 16, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'estatebase.estate': {
            ...
            'is_do_advertise': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_do_photo': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_exchange': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_exclusive': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_hypothec': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
