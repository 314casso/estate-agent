...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Estate.client_description'
        db.add_column('estatebase_estate', 'client_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Estate.client_description'
        db.delete_column('estatebase_estate', 'client_description')
