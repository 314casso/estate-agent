...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'YandexBuilding'
        db.create_table('estatebase_yandexbuilding', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, db_index=True)),
            ('building_id', self.gf('django.db.models.fields.CharField')(max_length=50, db_index=True)),
            ('ready_quarter', self.gf('django.db.models.fields.IntegerField')()),
            ('building_state', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ))
        db.send_create_signal('estatebase', ['YandexBuilding'])

        # Adding field 'Bidg.yandex_building'
        db.add_column('estatebase_bidg', 'yandex_building',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.YandexBuilding'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'YandexBuilding'
        db.delete_table('estatebase_yandexbuilding')

        # Deleting field 'Bidg.yandex_building'
        db.delete_column('estatebase_bidg', 'yandex_building_id')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 16, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
