...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Office.head'
        db.add_column('estatebase_office', 'head',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


        # Changing field 'Client.extra_profile'
        db.alter_column('estatebase_client', 'extra_profile_id', self.gf('django.db.models.fields.related.OneToOneField')(null=True, on_delete=models.SET_NULL, to=orm['devrep.ExtraProfile'], unique=True))

        # Changing field 'Client.dev_profile'
        db.alter_column('estatebase_client', 'dev_profile_id', self.gf('django.db.models.fields.related.OneToOneField')(null=True, on_delete=models.SET_NULL, to=orm['devrep.DevProfile'], unique=True))
        # Adding field 'UserProfile.phone'
        db.add_column('estatebase_userprofile', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Office.head'
        db.delete_column('estatebase_office', 'head_id')


        # Changing field 'Client.extra_profile'
        db.alter_column('estatebase_client', 'extra_profile_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['devrep.ExtraProfile'], unique=True, null=True))

        # Changing field 'Client.dev_profile'
        db.alter_column('estatebase_client', 'dev_profile_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['devrep.DevProfile'], unique=True, null=True))
        # Deleting field 'UserProfile.phone'
        db.delete_column('estatebase_userprofile', 'phone')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 1, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
