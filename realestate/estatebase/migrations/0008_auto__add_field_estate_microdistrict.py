...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Estate.microdistrict'
        db.add_column('estatebase_estate', 'microdistrict',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Microdistrict'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Estate.microdistrict'
        db.delete_column('estatebase_estate', 'microdistrict_id')
