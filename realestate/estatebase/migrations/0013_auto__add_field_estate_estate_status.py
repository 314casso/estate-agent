...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Estate.estate_status'
        db.add_column('estatebase_estate', 'estate_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['estatebase.EstateStatus']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Estate.estate_status'
        db.delete_column('estatebase_estate', 'estate_status_id')
