...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EstateType.view_prefix'
        db.delete_column('estatebase_estatetype', 'view_prefix')

        # Adding field 'EstateType.template'
        db.add_column('estatebase_estatetype', 'template',
                      self.gf('django.db.models.fields.CharField')(default='BIDG', max_length=50),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'EstateType.view_prefix'
        raise RuntimeError("Cannot reverse this migration. 'EstateType.view_prefix' and its values cannot be restored.")
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 11, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
