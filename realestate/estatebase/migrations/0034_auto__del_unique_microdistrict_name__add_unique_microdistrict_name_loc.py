...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Microdistrict', fields ['name', 'locality']
        db.create_unique('estatebase_microdistrict', ['name', 'locality_id'])

        # Adding unique constraint on 'Street', fields ['name', 'locality']
        db.create_unique('estatebase_street', ['name', 'locality_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Street', fields ['name', 'locality']
        db.delete_unique('estatebase_street', ['name', 'locality_id'])

        # Removing unique constraint on 'Microdistrict', fields ['name', 'locality']
        db.delete_unique('estatebase_microdistrict', ['name', 'locality_id'])
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 14, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
