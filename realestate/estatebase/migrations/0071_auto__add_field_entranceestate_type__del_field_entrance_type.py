...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntranceEstate.type'
        db.add_column('estatebase_entranceestate', 'type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'Entrance.type'
        db.delete_column('estatebase_entrance', 'type')


    def backwards(self, orm):
        # Deleting field 'EntranceEstate.type'
        db.delete_column('estatebase_entranceestate', 'type')


        # User chose to not deal with backwards NULL issues for 'Entrance.type'
        raise RuntimeError("Cannot reverse this migration. 'Entrance.type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Entrance.type'
        db.add_column('estatebase_entrance', 'type',
