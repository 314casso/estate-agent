...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Estate.region'
        db.add_column('estatebase_estate', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Region'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Estate.region'
        db.delete_column('estatebase_estate', 'region_id')
