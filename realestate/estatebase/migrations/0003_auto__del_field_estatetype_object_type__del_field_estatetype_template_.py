...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EstateType.object_type'
        db.delete_column('estatebase_estatetype', 'object_type')

        # Deleting field 'EstateType.template'
        db.delete_column('estatebase_estatetype', 'template')

        # Adding field 'EstateType.has_bidg'
        db.add_column('estatebase_estatetype', 'has_bidg',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'EstateType.has_stead'
        db.add_column('estatebase_estatetype', 'has_stead',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'EstateType.object_type'
        raise RuntimeError("Cannot reverse this migration. 'EstateType.object_type' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'EstateType.template'
        raise RuntimeError("Cannot reverse this migration. 'EstateType.template' and its values cannot be restored.")
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 6, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
