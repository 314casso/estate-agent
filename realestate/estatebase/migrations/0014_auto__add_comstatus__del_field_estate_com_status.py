...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ComStatus'
        db.create_table('estatebase_comstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, db_index=True)),
        ))
        db.send_create_signal('estatebase', ['ComStatus'])

        # Deleting field 'Estate.com_status'
        db.delete_column('estatebase_estate', 'com_status')


    def backwards(self, orm):
        # Deleting model 'ComStatus'
        db.delete_table('estatebase_comstatus')

        # Adding field 'Estate.com_status'
        db.add_column('estatebase_estate', 'com_status',
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 13, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
