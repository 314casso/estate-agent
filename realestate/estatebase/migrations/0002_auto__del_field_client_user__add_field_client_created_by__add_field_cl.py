...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('estatebase_client', 'user_id')

        # Adding field 'Client.created_by'
        db.add_column('estatebase_client', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='creators', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Client.updated_by'
        db.add_column('estatebase_client', 'updated_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='updaters', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Client.user'
        db.add_column('estatebase_client', 'user',
    ...
    models = {
        ...
        'estatebase.client': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'creators'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 31, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
