...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Region.regular_name'
        db.add_column('estatebase_region', 'regular_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Region.regular_name'
        db.delete_column('estatebase_region', 'regular_name')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 3, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
