...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('estatebase_streettype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, db_index=True)),
            ('sort_name', self.gf('django.db.models.fields.CharField')(max_length=50, db_index=True)),
        ))
        db.send_create_signal('estatebase', ['StreetType'])

        # Adding field 'Street.street_type'
        db.add_column('estatebase_street', 'street_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.StreetType'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StreetType'
        db.delete_table('estatebase_streettype')

        # Deleting field 'Street.street_type'
        db.delete_column('estatebase_street', 'street_type_id')
