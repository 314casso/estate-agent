...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Estate.contact'
        db.alter_column('estatebase_estate', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Contact'], null=True, on_delete=models.PROTECT))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Estate.contact'
        db.alter_column('estatebase_estate', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Contact'], null=True))
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 15, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
