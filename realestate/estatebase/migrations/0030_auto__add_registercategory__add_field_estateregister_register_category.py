...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RegisterCategory'
        db.create_table('estatebase_registercategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, db_index=True)),
        ))
        db.send_create_signal('estatebase', ['RegisterCategory'])

        # Adding field 'EstateRegister.register_category'
        db.add_column('estatebase_estateregister', 'register_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.RegisterCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'RegisterCategory'
        db.delete_table('estatebase_registercategory')

        # Deleting field 'EstateRegister.register_category'
        db.delete_column('estatebase_estateregister', 'register_category_id')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 21, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
