...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bid.history'
        db.add_column('estatebase_bid', 'history',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['estatebase.HistoryMeta'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bid.broker'
        db.add_column('estatebase_bid', 'broker',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='brokers', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Bid.agency_price_min'
        db.add_column('estatebase_bid', 'agency_price_min',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bid.agency_price_max'
        db.add_column('estatebase_bid', 'agency_price_max',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Changing field 'Bid.estate_filter'
        db.alter_column('estatebase_bid', 'estate_filter', self.gf('picklefield.fields.PickledObjectField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Bid.client'
        raise RuntimeError("Cannot reverse this migration. 'Bid.client' and its values cannot be restored.")
        # Deleting field 'Bid.history'
        db.delete_column('estatebase_bid', 'history_id')

        # Deleting field 'Bid.broker'
        db.delete_column('estatebase_bid', 'broker_id')

        # Deleting field 'Bid.agency_price_min'
        db.delete_column('estatebase_bid', 'agency_price_min')

        # Deleting field 'Bid.agency_price_max'
        db.delete_column('estatebase_bid', 'agency_price_max')
        ...
        # User chose to not deal with backwards NULL issues for 'Bid.estate_filter'
        raise RuntimeError("Cannot reverse this migration. 'Bid.estate_filter' and its values cannot be restored.")
    ...
    models = {
        ...
        'estatebase.bid': {
            ...
            'estate': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['estatebase.Estate']", 'null': 'True', 'blank': 'True'}),
