...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('estatebase_client', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 5, 27, 0, 0)),
                      keep_default=False)

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Client.creat_date'
        raise RuntimeError("Cannot reverse this migration. 'Client.creat_date' and its values cannot be restored.")
