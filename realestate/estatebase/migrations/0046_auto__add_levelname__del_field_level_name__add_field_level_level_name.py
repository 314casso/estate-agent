...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('estatebase_level', 'name')

        # Adding field 'Level.level_name'
        db.add_column('estatebase_level', 'level_name',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['estatebase.LevelName']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Level.level_name'
        db.delete_column('estatebase_level', 'level_name_id')
