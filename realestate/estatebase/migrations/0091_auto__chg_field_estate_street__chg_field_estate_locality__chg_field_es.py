...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('estatebase_estate', 'street_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Street'], null=True, on_delete=models.PROTECT))

        # Changing field 'Estate.locality'
        db.alter_column('estatebase_estate', 'locality_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Locality'], null=True, on_delete=models.PROTECT))

        # Changing field 'Estate.estate_number'
        db.alter_column('estatebase_estate', 'estate_number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Estate.street'
        raise RuntimeError("Cannot reverse this migration. 'Estate.street' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Estate.locality'
        raise RuntimeError("Cannot reverse this migration. 'Estate.locality' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Estate.estate_number'
        raise RuntimeError("Cannot reverse this migration. 'Estate.estate_number' and its values cannot be restored.")
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 30, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
