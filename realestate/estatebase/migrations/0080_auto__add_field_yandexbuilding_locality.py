...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'YandexBuilding.locality'
        db.add_column('estatebase_yandexbuilding', 'locality',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Locality'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'YandexBuilding.locality'
        db.delete_column('estatebase_yandexbuilding', 'locality_id')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 24, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
