...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Estate.address'
        db.alter_column('estatebase_estate', 'address_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['estatebase.Address'], unique=True, null=True))
        # Adding unique constraint on 'Estate', fields ['address']
        db.create_unique('estatebase_estate', ['address_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Estate', fields ['address']
        db.delete_unique('estatebase_estate', ['address_id'])


        # Changing field 'Estate.address'
        db.alter_column('estatebase_estate', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Address'], null=True))
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 17, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'estatebase.estate': {
            ...
            'address': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['estatebase.Address']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
