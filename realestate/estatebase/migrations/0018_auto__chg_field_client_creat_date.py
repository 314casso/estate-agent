...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Client.creat_date'
        db.alter_column('estatebase_client', 'creat_date', self.gf('django.db.models.fields.DateTimeField')())
    def backwards(self, orm):

        # Changing field 'Client.creat_date'
        db.alter_column('estatebase_client', 'creat_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    models = {
        'auth.group': {
        ...
        'estatebase.client': {
            ...
            'creat_date': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
