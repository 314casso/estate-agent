...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Locality.geo_group'
        db.delete_column('estatebase_locality', 'geo_group_id')

        # Adding field 'Region.geo_group'
        db.add_column('estatebase_region', 'geo_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['estatebase.GeoGroup'], on_delete=models.PROTECT),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Locality.geo_group'
        raise RuntimeError("Cannot reverse this migration. 'Locality.geo_group' and its values cannot be restored.")
        # Deleting field 'Region.geo_group'
        db.delete_column('estatebase_region', 'geo_group_id')
