...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'EntranceEstate', fields ['entrance', 'estate']
        db.delete_unique('estatebase_entranceestate', ['entrance_id', 'estate_id'])

        # Deleting model 'Entrance'
        db.delete_table('estatebase_entrance')

        # Deleting field 'EntranceEstate.entrance'
        db.delete_column('estatebase_entranceestate', 'entrance_id')

        # Adding field 'EntranceEstate.beside'
        db.add_column('estatebase_entranceestate', 'beside',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['estatebase.Beside']),
                      keep_default=False)

        # Adding unique constraint on 'EntranceEstate', fields ['beside', 'estate']
        db.create_unique('estatebase_entranceestate', ['beside_id', 'estate_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'EntranceEstate', fields ['beside', 'estate']
        db.delete_unique('estatebase_entranceestate', ['beside_id', 'estate_id'])

        # Adding model 'Entrance'
        db.create_table('estatebase_entrance', (
            ('name_loct', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name_gent', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, db_index=True)),
        ))
        db.send_create_signal('estatebase', ['Entrance'])


        # User chose to not deal with backwards NULL issues for 'EntranceEstate.entrance'
        raise RuntimeError("Cannot reverse this migration. 'EntranceEstate.entrance' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'EntranceEstate.entrance'
        db.add_column('estatebase_entranceestate', 'entrance',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Entrance']),
                      keep_default=False)

        # Deleting field 'EntranceEstate.beside'
        db.delete_column('estatebase_entranceestate', 'beside_id')

        # Adding unique constraint on 'EntranceEstate', fields ['entrance', 'estate']
        db.create_unique('estatebase_entranceestate', ['entrance_id', 'estate_id'])
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 17, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
