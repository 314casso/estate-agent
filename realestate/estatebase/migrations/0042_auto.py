...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'HistoryMeta', fields ['updated']
        db.create_index('estatebase_historymeta', ['updated'])

        # Adding index on 'HistoryMeta', fields ['created']
        db.create_index('estatebase_historymeta', ['created'])

        # Adding index on 'HistoryMeta', fields ['modificated']
        db.create_index('estatebase_historymeta', ['modificated'])


    def backwards(self, orm):
        # Removing index on 'HistoryMeta', fields ['modificated']
        db.delete_index('estatebase_historymeta', ['modificated'])

        # Removing index on 'HistoryMeta', fields ['created']
        db.delete_index('estatebase_historymeta', ['created'])

        # Removing index on 'HistoryMeta', fields ['updated']
        db.delete_index('estatebase_historymeta', ['updated'])
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 10, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
