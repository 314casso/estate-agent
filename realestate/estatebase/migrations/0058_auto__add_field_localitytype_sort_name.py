...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocalityType.sort_name'
        db.add_column('estatebase_localitytype', 'sort_name',
                      self.gf('django.db.models.fields.CharField')(default=u'u', max_length=50, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocalityType.sort_name'
        db.delete_column('estatebase_localitytype', 'sort_name')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 16, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
