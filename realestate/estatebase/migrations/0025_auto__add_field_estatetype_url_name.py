...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EstateType.url_name'
        db.add_column('estatebase_estatetype', 'url_name',
                      self.gf('django.db.models.fields.CharField')(default='estate_create', max_length=50),
                      keep_default=False)
