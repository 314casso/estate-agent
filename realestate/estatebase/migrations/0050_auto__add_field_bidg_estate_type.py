...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bidg.estate_type'
        db.add_column('estatebase_bidg', 'estate_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.EstateType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bidg.estate_type'
        db.delete_column('estatebase_bidg', 'estate_type_id')
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 10, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
