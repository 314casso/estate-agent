...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('estatebase_estate', 'estate_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['estatebase.EstateType']))

    def backwards(self, orm):

        # Changing field 'Estate.estate_type'
        db.alter_column('estatebase_estate', 'estate_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.EstateType'], null=True))
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 13, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
