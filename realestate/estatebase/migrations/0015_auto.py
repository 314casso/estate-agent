...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Contact', fields ['contact']
        db.create_index('estatebase_contact', ['contact'])


    def backwards(self, orm):
        
        # Removing index on 'Contact', fields ['contact']
        db.delete_index('estatebase_contact', ['contact'])
    ...
    models = {
        ...
        'estatebase.contacthistory': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 25, 11, 7, 22, 320000)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
