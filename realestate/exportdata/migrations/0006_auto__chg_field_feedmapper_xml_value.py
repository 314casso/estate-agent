...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeedMapper.xml_value'
        db.alter_column('exportdata_feedmapper', 'xml_value', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FeedMapper.xml_value'
        raise RuntimeError("Cannot reverse this migration. 'FeedMapper.xml_value' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'FeedMapper.xml_value'
        db.alter_column('exportdata_feedmapper', 'xml_value', self.gf('django.db.models.fields.CharField')(max_length=255))
