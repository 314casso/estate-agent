...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContentTypeMapper.mapper_engine'
        db.add_column('exportdata_contenttypemapper', 'mapper_engine',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['exportdata.MapperEngine']),
                      keep_default=False)

        # Removing M2M table for field mapper_engines on 'ContentTypeMapper'
        db.delete_table(db.shorten_name('exportdata_contenttypemapper_mapper_engines'))
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field mapper_engines on 'ContentTypeMapper'
        m2m_table_name = db.shorten_name('exportdata_contenttypemapper_mapper_engines')
    ...
    models = {
        ...
        'exportdata.mappednode': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mapper_engine': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'nodes'", 'to': "orm['exportdata.MapperEngine']"}),
