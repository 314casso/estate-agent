...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('exportdata_basefeed', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('rules_url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal('exportdata', ['BaseFeed'])

        # Deleting field 'FeedMapper.feed_name'
        db.delete_column('exportdata_feedmapper', 'feed_name')

        # Adding field 'FeedMapper.feed'
        db.add_column('exportdata_feedmapper', 'feed',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['exportdata.BaseFeed']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('exportdata_basefeed')


        # User chose to not deal with backwards NULL issues for 'FeedMapper.feed_name'
        raise RuntimeError("Cannot reverse this migration. 'FeedMapper.feed_name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'FeedMapper.feed_name'
        db.add_column('exportdata_feedmapper', 'feed_name',
                      self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True),
                      keep_default=False)

        # Deleting field 'FeedMapper.feed'
        db.delete_column('exportdata_feedmapper', 'feed_id')
