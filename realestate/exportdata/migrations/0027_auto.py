...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field estate_types on 'BaseFeed'
        m2m_table_name = db.shorten_name('exportdata_basefeed_estate_types')
        ...
        db.create_unique(m2m_table_name, ['basefeed_id', 'estatetype_id'])


    def backwards(self, orm):
        # Removing M2M table for field estate_types on 'BaseFeed'
        db.delete_table(db.shorten_name('exportdata_basefeed_estate_types'))
    ...
    models = {
        ...
        'exportdata.contenttypemapper': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order_by': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'})
        },
        ...
        'exportdata.marketingcampaign': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 24, 0, 0)'})
        },
