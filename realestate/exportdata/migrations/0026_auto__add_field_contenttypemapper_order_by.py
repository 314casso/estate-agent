...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContentTypeMapper.order_by'
        db.add_column('exportdata_contenttypemapper', 'order_by',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContentTypeMapper.order_by'
        db.delete_column('exportdata_contenttypemapper', 'order_by')
