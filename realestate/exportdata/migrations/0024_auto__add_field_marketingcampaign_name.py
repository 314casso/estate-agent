...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarketingCampaign.name'
        db.add_column('exportdata_marketingcampaign', 'name',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=15, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MarketingCampaign.name'
        db.delete_column('exportdata_marketingcampaign', 'name')
    ...
    models = {
        ...
        'exportdata.marketingcampaign': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 13, 0, 0)'})
        },
