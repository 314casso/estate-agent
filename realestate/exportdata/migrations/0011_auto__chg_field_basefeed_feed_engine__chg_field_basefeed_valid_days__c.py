...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BaseFeed.feed_engine'
        db.alter_column('exportdata_basefeed', 'feed_engine_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['exportdata.FeedEngine']))

        # Changing field 'BaseFeed.valid_days'
        db.alter_column('exportdata_basefeed', 'valid_days', self.gf('django.db.models.fields.IntegerField')(default=1))

        # Changing field 'BaseFeed.mapper_engine'
        db.alter_column('exportdata_basefeed', 'mapper_engine_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['exportdata.MapperEngine']))

    def backwards(self, orm):

        # Changing field 'BaseFeed.feed_engine'
        db.alter_column('exportdata_basefeed', 'feed_engine_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exportdata.FeedEngine'], null=True))

        # Changing field 'BaseFeed.valid_days'
        db.alter_column('exportdata_basefeed', 'valid_days', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'BaseFeed.mapper_engine'
        db.alter_column('exportdata_basefeed', 'mapper_engine_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exportdata.MapperEngine'], null=True))
