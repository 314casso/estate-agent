...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FeedLocality'
        db.create_table('exportdata_feedlocality', (
            ...
            ('feed_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
        ))
        db.send_create_signal('exportdata', ['FeedLocality'])


    def backwards(self, orm):
        # Deleting model 'FeedLocality'
        db.delete_table('exportdata_feedlocality')
    ...
    models = {
        ...
        'exportdata.feedlocality': {
            'Meta': {'ordering': "['locality']", 'object_name': 'FeedLocality'},
