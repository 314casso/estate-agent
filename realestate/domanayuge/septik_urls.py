...
from domanayuge.views import Blog, Article, MapPage, PrivacyPolicyPage, \
    ...
    septik_sitemap, SeptikPriceList, SeptikPrice, SeptikBaseCaseList, TermsOfUse
import settings
...
urlpatterns = patterns('',   
    ...
    url(r'^karta-doma-na-yuge/$', MapPage.as_view(), {"sitemap_source": septik_sitemap}, name='karta-doma-na-yuge'),
