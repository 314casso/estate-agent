...
from domanayuge.views import Blog, Article, MapPage, PrivacyPolicyPage, \
    ...
    RodlexPage,\
    RodlexList, RodlexPriceList, RodlexPrice, RodlexCaseList, RodlexCase, TermsOfUse
import settings
...
urlpatterns = patterns('',   
    ...
    url(r'^karta-doma-na-yuge/$', MapPage.as_view(), {"sitemap_source": rodlex_sitemap}, name='karta-doma-na-yuge'),
