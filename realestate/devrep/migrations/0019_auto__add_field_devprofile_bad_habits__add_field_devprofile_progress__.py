...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DevProfile.bad_habits'
        db.add_column('devrep_devprofile', 'bad_habits',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DevProfile.progress'
        db.add_column('devrep_devprofile', 'progress',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DevProfile.pc_skills'
        db.add_column('devrep_devprofile', 'pc_skills',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'DevProfile.bad_habits'
        db.delete_column('devrep_devprofile', 'bad_habits')

        # Deleting field 'DevProfile.progress'
        db.delete_column('devrep_devprofile', 'progress')

        # Deleting field 'DevProfile.pc_skills'
        db.delete_column('devrep_devprofile', 'pc_skills')
