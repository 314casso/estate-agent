...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DevProfile.has_transport'
        db.delete_column('devrep_devprofile', 'has_transport')

        # Adding field 'DevProfile.gears'
        db.add_column('devrep_devprofile', 'gears',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DevProfile.transport'
        db.add_column('devrep_devprofile', 'transport',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding field 'DevProfile.has_transport'
        db.add_column('devrep_devprofile', 'has_transport',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'DevProfile.gears'
        db.delete_column('devrep_devprofile', 'gears')

        # Deleting field 'DevProfile.transport'
        db.delete_column('devrep_devprofile', 'transport')
