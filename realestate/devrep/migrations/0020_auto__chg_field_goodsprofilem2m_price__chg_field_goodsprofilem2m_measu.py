...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GoodsProfileM2M.price'
        db.alter_column('devrep_goodsprofilem2m', 'price', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'GoodsProfileM2M.measure'
        db.alter_column('devrep_goodsprofilem2m', 'measure_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devrep.Measure'], null=True))

        # Changing field 'WorkTypeProfile.price_max'
        db.alter_column('devrep_worktypeprofile', 'price_max', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'WorkTypeProfile.price_min'
        db.alter_column('devrep_worktypeprofile', 'price_min', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'GoodsProfileM2M.price'
        raise RuntimeError("Cannot reverse this migration. 'GoodsProfileM2M.price' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'GoodsProfileM2M.price'
        db.alter_column('devrep_goodsprofilem2m', 'price', self.gf('django.db.models.fields.IntegerField')())

        # User chose to not deal with backwards NULL issues for 'GoodsProfileM2M.measure'
        raise RuntimeError("Cannot reverse this migration. 'GoodsProfileM2M.measure' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'GoodsProfileM2M.measure'
        db.alter_column('devrep_goodsprofilem2m', 'measure_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devrep.Measure']))

        # User chose to not deal with backwards NULL issues for 'WorkTypeProfile.price_max'
        raise RuntimeError("Cannot reverse this migration. 'WorkTypeProfile.price_max' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'WorkTypeProfile.price_max'
        db.alter_column('devrep_worktypeprofile', 'price_max', self.gf('django.db.models.fields.IntegerField')())

        # User chose to not deal with backwards NULL issues for 'WorkTypeProfile.price_min'
        raise RuntimeError("Cannot reverse this migration. 'WorkTypeProfile.price_min' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'WorkTypeProfile.price_min'
        db.alter_column('devrep_worktypeprofile', 'price_min', self.gf('django.db.models.fields.IntegerField')())
