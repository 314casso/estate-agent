...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Partner.parent'
        db.add_column('devrep_partner', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['devrep.Partner']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partner.parent'
        db.delete_column('devrep_partner', 'parent_id')
