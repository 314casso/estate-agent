...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GoodsProfileM2M'
        db.create_table('devrep_goodsprofilem2m', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('goods', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devrep.Goods'])),
        ...
        db.send_create_signal('devrep', ['GoodsProfileM2M'])

        # Adding unique constraint on 'GoodsProfileM2M', fields ['goods', 'dev_profile']
        db.create_unique('devrep_goodsprofilem2m', ['goods_id', 'dev_profile_id'])

        # Adding model 'Goods'
        db.create_table('devrep_goods', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=150, db_index=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['devrep.Goods'])),
            ('type', self.gf('django.db.models.fields.CharField')(default='G', max_length=1, db_index=True, blank=True)),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal('devrep', ['Goods'])


    def backwards(self, orm):
        # Removing unique constraint on 'GoodsProfileM2M', fields ['goods', 'dev_profile']
        db.delete_unique('devrep_goodsprofilem2m', ['goods_id', 'dev_profile_id'])

        # Deleting model 'GoodsProfileM2M'
        db.delete_table('devrep_goodsprofilem2m')

        # Deleting model 'Goods'
        db.delete_table('devrep_goods')
