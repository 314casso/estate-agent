...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkType.measure'
        db.add_column('devrep_worktype', 'measure',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devrep.Measure'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkType.measure'
        db.delete_column('devrep_worktype', 'measure_id')
