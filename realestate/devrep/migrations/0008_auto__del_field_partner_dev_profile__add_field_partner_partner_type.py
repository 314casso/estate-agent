...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('devrep_partner', 'partner_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='partner', to=orm['devrep.PartnerType']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('devrep_partner', 'dev_profile',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='partner', unique=True, null=True, to=orm['devrep.DevProfile'], blank=True),
                      keep_default=False)

        # Deleting field 'Partner.partner_type'
        db.delete_column('devrep_partner', 'partner_type_id')
