...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExtraProfile.adress'
        db.delete_column('devrep_extraprofile', 'adress_id')

        # Adding field 'ExtraProfile.address'
        db.add_column('devrep_extraprofile', 'address',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='extra_profile', unique=True, null=True, to=orm['devrep.Address']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ExtraProfile.adress'
        db.add_column('devrep_extraprofile', 'adress',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='extra_profile', unique=True, null=True, to=orm['devrep.Address'], blank=True),
                      keep_default=False)

        # Deleting field 'ExtraProfile.address'
        db.delete_column('devrep_extraprofile', 'address_id')
