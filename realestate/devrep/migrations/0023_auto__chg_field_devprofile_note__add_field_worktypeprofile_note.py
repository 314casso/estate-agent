...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DevProfile.note'
        db.alter_column('devrep_devprofile', 'note', self.gf('django.db.models.fields.TextField')(null=True))
        # Adding field 'WorkTypeProfile.note'
        db.add_column('devrep_worktypeprofile', 'note',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'DevProfile.note'
        db.alter_column('devrep_devprofile', 'note', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        # Deleting field 'WorkTypeProfile.note'
        db.delete_column('devrep_worktypeprofile', 'note')
