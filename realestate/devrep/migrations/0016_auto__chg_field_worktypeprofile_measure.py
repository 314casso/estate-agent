...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkTypeProfile.measure'
        db.alter_column('devrep_worktypeprofile', 'measure_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devrep.Measure'], null=True))

    def backwards(self, orm):

        # Changing field 'WorkTypeProfile.measure'
        db.alter_column('devrep_worktypeprofile', 'measure_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['devrep.Measure']))
