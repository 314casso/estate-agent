...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Partner.address'
        db.add_column('devrep_partner', 'address',
    ...
    def backwards(self, orm):
        ...
        db.add_column('devrep_partner', 'adress',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='partner', unique=True, null=True, to=orm['devrep.Address'], blank=True),
                      keep_default=False)

        # Deleting field 'Partner.address'
        db.delete_column('devrep_partner', 'address_id')
