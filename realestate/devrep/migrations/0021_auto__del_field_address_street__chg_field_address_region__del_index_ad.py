...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Address.street'
        db.delete_column('devrep_address', 'street_id')


        # Renaming column for 'Address.region' to match new field type.
        db.rename_column('devrep_address', 'region_id', 'region')
        # Changing field 'Address.region'
        db.alter_column('devrep_address', 'region', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
        # Removing index on 'Address', fields ['region']
        db.delete_index('devrep_address', ['region_id'])


        # Renaming column for 'Address.locality' to match new field type.
        db.rename_column('devrep_address', 'locality_id', 'locality')
        # Changing field 'Address.locality'
        db.alter_column('devrep_address', 'locality', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
        # Removing index on 'Address', fields ['locality']
        db.delete_index('devrep_address', ['locality_id'])


        # Changing field 'Address.address'
        db.alter_column('devrep_address', 'address', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):
        # Adding index on 'Address', fields ['locality']
        db.create_index('devrep_address', ['locality_id'])

        # Adding index on 'Address', fields ['region']
        db.create_index('devrep_address', ['region_id'])

        # Adding field 'Address.street'
        db.add_column('devrep_address', 'street',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Street'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Address.region'
        raise RuntimeError("Cannot reverse this migration. 'Address.region' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Renaming column for 'Address.region' to match new field type.
        db.rename_column('devrep_address', 'region', 'region_id')
        # Changing field 'Address.region'
        db.alter_column('devrep_address', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Region'], on_delete=models.PROTECT))

        # Renaming column for 'Address.locality' to match new field type.
        db.rename_column('devrep_address', 'locality', 'locality_id')
        # Changing field 'Address.locality'
        db.alter_column('devrep_address', 'locality_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Locality'], null=True, on_delete=models.PROTECT))

        # Changing field 'Address.address'
        db.alter_column('devrep_address', 'address', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
