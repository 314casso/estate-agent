...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Partner.adress'
        raise RuntimeError("Cannot reverse this migration. 'Partner.adress' and its values cannot be restored.")
    ...
    models = {
        ...
        'devrep.partner': {
            ...
            'adresses': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'partners'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['devrep.Address']"}),
