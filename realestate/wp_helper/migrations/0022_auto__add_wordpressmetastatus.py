...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WordpressMetaStatus'
        db.create_table('wp_helper_wordpressmetastatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('wp_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10, blank=True)),
        ))
        db.send_create_signal('wp_helper', ['WordpressMetaStatus'])

        # Adding M2M table for field estate_statuses on 'WordpressMetaStatus'
        m2m_table_name = db.shorten_name('wp_helper_wordpressmetastatus_estate_statuses')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('wordpressmetastatus', models.ForeignKey(orm['wp_helper.wordpressmetastatus'], null=False)),
            ('estatestatus', models.ForeignKey(orm['estatebase.estatestatus'], null=False))
        ))
        db.create_unique(m2m_table_name, ['wordpressmetastatus_id', 'estatestatus_id'])


    def backwards(self, orm):
        # Deleting model 'WordpressMetaStatus'
        db.delete_table('wp_helper_wordpressmetastatus')

        # Removing M2M table for field estate_statuses on 'WordpressMetaStatus'
        db.delete_table(db.shorten_name('wp_helper_wordpressmetastatus_estate_statuses'))
    ...
    models = {
        ...
        'wp_helper.wordpressmetaregion': {
            'Meta': {'object_name': 'WordpressMetaRegion'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'regions': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'wp_region_taxons'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['estatebase.Region']"}),
            'wp_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '10', 'blank': 'True'})
        },
        'wp_helper.wordpressmetastatus': {
            'Meta': {'object_name': 'WordpressMetaStatus'},
            'estate_statuses': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'wp_region_taxons'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['estatebase.EstateStatus']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'wp_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '10', 'blank': 'True'})
        },
