...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WordpressMetaEstateParam.name'
        db.delete_column('wp_helper_wordpressmetaestateparam', 'name')

        # Deleting field 'WordpressMetaEstateParam.wp_id'
        db.delete_column('wp_helper_wordpressmetaestateparam', 'wp_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'WordpressMetaEstateParam.name'
        raise RuntimeError("Cannot reverse this migration. 'WordpressMetaEstateParam.name' and its values cannot be restored.")
        # Adding field 'WordpressMetaEstateParam.wp_id'
        db.add_column('wp_helper_wordpressmetaestateparam', 'wp_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, unique=True, blank=True),
                      keep_default=False)
