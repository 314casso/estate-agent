...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EstateWordpressMeta.post_id'
        db.alter_column('wp_helper_estatewordpressmeta', 'post_id', self.gf('django.db.models.fields.CharField')(max_length=10, unique=True, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'EstateWordpressMeta.post_id'
        raise RuntimeError("Cannot reverse this migration. 'EstateWordpressMeta.post_id' and its values cannot be restored.")
