...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EstateWordpressMeta'
        db.create_table('wp_helper_estatewordpressmeta', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('estate', self.gf('django.db.models.fields.related.OneToOneField')(related_name='wp_meta', unique=True, to=orm['estatebase.Estate'])),
            ('post_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('wp_helper', ['EstateWordpressMeta'])


    def backwards(self, orm):
        # Deleting model 'EstateWordpressMeta'
        db.delete_table('wp_helper_estatewordpressmeta')
    ...
    models = {
        ...
        'wp_helper.estatewordpressmeta': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '10'}),
            'status': ('django.db.models.fields.IntegerField', [], {}),
