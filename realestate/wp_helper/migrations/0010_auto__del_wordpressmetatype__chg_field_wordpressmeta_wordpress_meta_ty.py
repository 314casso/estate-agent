...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'WordpressMeta.wordpress_meta_type' to match new field type.
        db.rename_column('wp_helper_wordpressmeta', 'wordpress_meta_type_id', 'wordpress_meta_type')
        # Changing field 'WordpressMeta.wordpress_meta_type'
        db.alter_column('wp_helper_wordpressmeta', 'wordpress_meta_type', self.gf('django.db.models.fields.IntegerField')())
        # Removing index on 'WordpressMeta', fields ['wordpress_meta_type']
        db.delete_index('wp_helper_wordpressmeta', ['wordpress_meta_type_id'])


    def backwards(self, orm):
        # Adding index on 'WordpressMeta', fields ['wordpress_meta_type']
        db.create_index('wp_helper_wordpressmeta', ['wordpress_meta_type_id'])
        ...
        # Renaming column for 'WordpressMeta.wordpress_meta_type' to match new field type.
        db.rename_column('wp_helper_wordpressmeta', 'wordpress_meta_type', 'wordpress_meta_type_id')
        # Changing field 'WordpressMeta.wordpress_meta_type'
        db.alter_column('wp_helper_wordpressmeta', 'wordpress_meta_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wp_helper.WordpressMetaType']))
