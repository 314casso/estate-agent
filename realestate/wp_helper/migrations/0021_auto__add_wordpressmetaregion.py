...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WordpressMetaRegion'
        db.create_table('wp_helper_wordpressmetaregion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('wp_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10, blank=True)),
        ))
        db.send_create_signal('wp_helper', ['WordpressMetaRegion'])

        # Adding M2M table for field regions on 'WordpressMetaRegion'
        m2m_table_name = db.shorten_name('wp_helper_wordpressmetaregion_regions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('wordpressmetaregion', models.ForeignKey(orm['wp_helper.wordpressmetaregion'], null=False)),
            ('region', models.ForeignKey(orm['estatebase.region'], null=False))
        ))
        db.create_unique(m2m_table_name, ['wordpressmetaregion_id', 'region_id'])


    def backwards(self, orm):
        # Deleting model 'WordpressMetaRegion'
        db.delete_table('wp_helper_wordpressmetaregion')

        # Removing M2M table for field regions on 'WordpressMetaRegion'
        db.delete_table(db.shorten_name('wp_helper_wordpressmetaregion_regions'))
