...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WordpressTaxonomyTree.wp_meta_locality'
        db.add_column('wp_helper_wordpresstaxonomytree', 'wp_meta_locality',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wp_helper.WordpressMeta'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WordpressTaxonomyTree.wp_meta_locality'
        db.delete_column('wp_helper_wordpresstaxonomytree', 'wp_meta_locality_id')
