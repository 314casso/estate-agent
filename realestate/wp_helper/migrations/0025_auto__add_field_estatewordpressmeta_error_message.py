...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EstateWordpressMeta.error_message'
        db.add_column('wp_helper_estatewordpressmeta', 'error_message',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EstateWordpressMeta.error_message'
        db.delete_column('wp_helper_estatewordpressmeta', 'error_message')
