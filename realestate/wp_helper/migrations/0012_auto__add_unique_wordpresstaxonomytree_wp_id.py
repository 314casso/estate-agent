...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'WordpressTaxonomyTree', fields ['wp_id']
        db.create_unique('wp_helper_wordpresstaxonomytree', ['wp_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'WordpressTaxonomyTree', fields ['wp_id']
        db.delete_unique('wp_helper_wordpresstaxonomytree', ['wp_id'])
