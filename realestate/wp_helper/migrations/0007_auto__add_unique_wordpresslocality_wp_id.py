...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'WordpressLocality', fields ['wp_id']
        db.create_unique('wp_helper_wordpresslocality', ['wp_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'WordpressLocality', fields ['wp_id']
        db.delete_unique('wp_helper_wordpresslocality', ['wp_id'])
    ...
    models = {
        ...
        'wp_helper.wordpresslocality': {
            'Meta': {'object_name': 'WordpressLocality'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
