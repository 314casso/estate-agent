...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WordpressMetaEstateParam.wp_postmeta_key'
        db.add_column('wp_helper_wordpressmetaestateparam', 'wp_postmeta_key',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WordpressMetaEstateParam.wp_postmeta_value'
        db.add_column('wp_helper_wordpressmetaestateparam', 'wp_postmeta_value',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WordpressMetaEstateParam.wp_postmeta_key'
        db.delete_column('wp_helper_wordpressmetaestateparam', 'wp_postmeta_key')

        # Deleting field 'WordpressMetaEstateParam.wp_postmeta_value'
        db.delete_column('wp_helper_wordpressmetaestateparam', 'wp_postmeta_value')
    ...
    models = {
        ...
        'wp_helper.wordpressmetaestateparam': {
            'Meta': {'ordering': "['id']", 'object_name': 'WordpressMetaEstateParam'},
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'taxonomy_tree': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['wp_helper.WordpressTaxonomyTree']", 'null': 'True', 'blank': 'True'}),
            'wp_postmeta_key': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'wp_postmeta_value': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'})
        },
