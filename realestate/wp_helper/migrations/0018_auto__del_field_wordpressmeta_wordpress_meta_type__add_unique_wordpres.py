...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('wp_helper_wordpressmeta', 'wordpress_meta_type')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'WordpressMeta.wordpress_meta_type'
        raise RuntimeError("Cannot reverse this migration. 'WordpressMeta.wordpress_meta_type' and its values cannot be restored.")
