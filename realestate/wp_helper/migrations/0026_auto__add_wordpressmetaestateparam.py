...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WordpressMetaEstateParam'
        db.create_table('wp_helper_wordpressmetaestateparam', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('wp_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10, blank=True)),
        ))
        db.send_create_signal('wp_helper', ['WordpressMetaEstateParam'])

        # Adding M2M table for field estate_params on 'WordpressMetaEstateParam'
        m2m_table_name = db.shorten_name('wp_helper_wordpressmetaestateparam_estate_params')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('wordpressmetaestateparam', models.ForeignKey(orm['wp_helper.wordpressmetaestateparam'], null=False)),
            ('estateparam', models.ForeignKey(orm['estatebase.estateparam'], null=False))
        ))
        db.create_unique(m2m_table_name, ['wordpressmetaestateparam_id', 'estateparam_id'])


    def backwards(self, orm):
        # Deleting model 'WordpressMetaEstateParam'
        db.delete_table('wp_helper_wordpressmetaestateparam')

        # Removing M2M table for field estate_params on 'WordpressMetaEstateParam'
        db.delete_table(db.shorten_name('wp_helper_wordpressmetaestateparam_estate_params'))
