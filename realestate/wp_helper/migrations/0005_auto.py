...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field localities on 'WordpressTaxonomyTree'
        m2m_table_name = db.shorten_name('wp_helper_wordpresstaxonomytree_localities')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('wordpresstaxonomytree', models.ForeignKey(orm['wp_helper.wordpresstaxonomytree'], null=False)),
            ('locality', models.ForeignKey(orm['estatebase.locality'], null=False))
        ))
        db.create_unique(m2m_table_name, ['wordpresstaxonomytree_id', 'locality_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field localities on 'WordpressTaxonomyTree'
        db.delete_table(db.shorten_name('wp_helper_wordpresstaxonomytree_localities'))
