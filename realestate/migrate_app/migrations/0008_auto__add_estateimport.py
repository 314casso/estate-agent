...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EstateImport'
        db.create_table('migrate_app_estateimport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('estate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estatebase.Estate'], null=True, on_delete=models.SET_NULL, blank=True)),
            ('external_id', self.gf('django.db.models.fields.IntegerField')(unique=True)),
        ))
        db.send_create_signal('migrate_app', ['EstateImport'])


    def backwards(self, orm):
        # Deleting model 'EstateImport'
        db.delete_table('migrate_app_estateimport')
    ...
    models = {
        ...
        'migrate_app.estateimport': {
            'Meta': {'object_name': 'EstateImport'},
            'estate': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['estatebase.Estate']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'external_id': ('django.db.models.fields.IntegerField', [], {'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
