...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserUser'
        db.create_table('migrate_app_useruser', (
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('source_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
        ))
        db.send_create_signal('migrate_app', ['UserUser'])


    def backwards(self, orm):
        # Deleting model 'UserUser'
        db.delete_table('migrate_app_useruser')
