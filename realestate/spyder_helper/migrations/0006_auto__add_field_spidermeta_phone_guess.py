...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpiderMeta.phone_guess'
        db.add_column('spyder_helper_spidermeta', 'phone_guess',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpiderMeta.phone_guess'
        db.delete_column('spyder_helper_spidermeta', 'phone_guess')
