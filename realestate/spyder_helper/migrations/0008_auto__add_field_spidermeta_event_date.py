...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpiderMeta.event_date'
        db.add_column('spyder_helper_spidermeta', 'event_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 8, 13, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpiderMeta.event_date'
        db.delete_column('spyder_helper_spidermeta', 'event_date')
    ...
    models = {
        ...
        'spyder_helper.spidermeta': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 13, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
