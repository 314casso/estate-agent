...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpiderMeta.phone'
        db.add_column('spyder_helper_spidermeta', 'phone',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpiderMeta.phone'
        db.delete_column('spyder_helper_spidermeta', 'phone')
